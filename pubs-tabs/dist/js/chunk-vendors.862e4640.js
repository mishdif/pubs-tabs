 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vt(t){if(t.code!==P.FAILED_PRECONDITION||t.message!==mt)throw t;x("LocalStore","Unexpectedly lost primary lease")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pt="documentMutations",Lt="remoteDocumentsV14",Vt="remoteDocumentGlobal",Ft="targets",Ut="targetDocuments",jt="targetGlobal",Bt="collectionParents",$t="clientMetadata",zt="bundles",qt="namedQueries",Kt="indexConfiguration",Ht="indexState",Gt="indexEntries",Qt="documentOverlays",Wt="globals",Xt=[Rt,Mt,Pt,Nt,Ft,Ot,jt,Ut,$t,Vt,Bt,zt,qt],Yt=[Rt,Mt,Pt,Lt,Ft,Ot,jt,Ut,$t,Vt,Bt,zt,qt,Qt],Zt=Yt,Jt=[...Zt,Kt,Ht,Gt];
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ge{constructor(t){this.value=t}static empty(){return new Ge({mapValue:{}})}field(t){if(t.isEmpty())return this.value;{let e=this.value;for(let n=0;n<t.length-1;++n)if(e=(e.mapValue.fields||{})[t.get(n)],!ze(e))return null;return e=(e.mapValue.fields||{})[t.lastSegment()],e||null}}set(t,e){this.getFieldsMap(t.popLast())[t.lastSegment()]=Ke(e)}setAll(t){let e=ct.emptyPath(),n={},r=[];t.forEach((t,i)=>{if(!e.isImmediateParentOf(i)){const t=this.getFieldsMap(e);this.applyChanges(t,n,r),n={},r=[],e=i.popLast()}t?n[i.lastSegment()]=Ke(t):r.push(i.lastSegment())});const i=this.getFieldsMap(e);this.applyChanges(i,n,r)}delete(t){const e=this.field(t.popLast());ze(e)&&e.mapValue.fields&&delete e.mapValue.fields[t.lastSegment()]}isEqual(t){return Ne(this.value,t.value)}getFieldsMap(t){let e=this.value;e.mapValue.fields||(e.mapValue={fields:{}});for(let n=0;n<t.length;++n){let r=e.mapValue.fields[t.get(n)];ze(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},e.mapValue.fields[t.get(n)]=r),e=r}return e.mapValue.fields}applyChanges(t,e,n){ee(e,(e,n)=>t[e]=n);for(const r of n)delete t[r]}clone(){return new Ge(Ke(this.value))}}function Qe(t){const e=[];return ee(t.fields,(t,n)=>{const r=new ct([t]);if(ze(n)){const t=Qe(n.mapValue).fields;if(0===t.length)e.push(r);else for(const n of t)e.push(r.child(n))}else e.push(r)}),new ce(e)
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Je{constructor(t,e="asc"){this.field=t,this.dir=e}}function tn(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en{}class nn extends en{constructor(t,e,n){super(),this.field=t,this.op=e,this.value=n}static create(t,e,n){return t.isKeyField()?"in"===e||"not-in"===e?this.createKeyFieldInFilter(t,e,n):new hn(t,e,n):"array-contains"===e?new gn(t,n):"in"===e?new mn(t,n):"not-in"===e?new yn(t,n):"array-contains-any"===e?new vn(t,n):new nn(t,e,n)}static createKeyFieldInFilter(t,e,n){return"in"===e?new fn(t,n):new dn(t,n)}matches(t){const e=t.data.field(this.field);return"!="===this.op?null!==e&&void 0===e.nullValue&&this.matchesComparison(Re(e,this.value)):null!==e&&ke(this.value)===ke(e)&&this.matchesComparison(Re(e,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return 0===t;case"!=":return 0!==t;case">":return t>0;case">=":return t>=0;default:return N(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class rn extends en{constructor(t,e){super(),this.filters=t,this.op=e,this.Te=null}static create(t,e){return new rn(t,e)}matches(t){return sn(this)?void 0===this.filters.find(e=>!e.matches(t)):void 0!==this.filters.find(e=>e.matches(t))}getFlattenedFilters(){return null!==this.Te||(this.Te=this.filters.reduce((t,e)=>t.concat(e.getFlattenedFilters()),[])),this.Te}getFilters(){return Object.assign([],this.filters)}}function sn(t){return"and"===t.op}function on(t){return an(t)&&sn(t)}function an(t){for(const e of t.filters)if(e instanceof rn)return!1;return!0}function cn(t){if(t instanceof nn)return t.field.canonicalString()+t.op.toString()+Le(t.value);if(on(t))return t.filters.map(t=>cn(t)).join(",");{const e=t.filters.map(t=>cn(t)).join(",");return`${t.op}(${e})`}}function un(t,e){return t instanceof nn?function(t,e){return e instanceof nn&&t.op===e.op&&t.field.isEqual(e.field)&&Ne(t.value,e.value)}(t,e):t instanceof rn?function(t,e){return e instanceof rn&&t.op===e.op&&t.filters.length===e.filters.length&&t.filters.reduce((t,n,r)=>t&&un(n,e.filters[r]),!0)}(t,e):void N(19439)}function ln(t){return t instanceof nn?function(t){return`${t.field.canonicalString()} ${t.op} ${Le(t.value)}`}(t):t instanceof rn?function(t){return t.op.toString()+" {"+t.getFilters().map(ln).join(" ,")+"}"}(t):"Filter"}class hn extends nn{constructor(t,e,n){super(t,e,n),this.key=ut.fromName(n.referenceValue)}matches(t){const e=ut.comparator(t.key,this.key);return this.matchesComparison(e)}}class fn extends nn{constructor(t,e){super(t,"in",e),this.keys=pn("in",e)}matches(t){return this.keys.some(e=>e.isEqual(t.key))}}class dn extends nn{constructor(t,e){super(t,"not-in",e),this.keys=pn("not-in",e)}matches(t){return!this.keys.some(e=>e.isEqual(t.key))}}function pn(t,e){var n;return((null===(n=e.arrayValue)||void 0===n?void 0:n.values)||[]).map(t=>ut.fromName(t.referenceValue))}class gn extends nn{constructor(t,e){super(t,"array-contains",e)}matches(t){const e=t.data.field(this.field);return je(e)&&Oe(e.arrayValue,this.value)}}class mn extends nn{constructor(t,e){super(t,"in",e)}matches(t){const e=t.data.field(this.field);return null!==e&&Oe(this.value.arrayValue,e)}}class yn extends nn{constructor(t,e){super(t,"not-in",e)}matches(t){if(Oe(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const e=t.data.field(this.field);return null!==e&&void 0===e.nullValue&&!Oe(this.value.arrayValue,e)}}class vn extends nn{constructor(t,e){super(t,"array-contains-any",e)}matches(t){const e=t.data.field(this.field);return!(!je(e)||!e.arrayValue.values)&&e.arrayValue.values.some(t=>Oe(this.value.arrayValue,t))}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wn{constructor(t,e=null,n=[],r=[],i=null,s=null,o=null){this.path=t,this.collectionGroup=e,this.orderBy=n,this.filters=r,this.limit=i,this.startAt=s,this.endAt=o,this.Ie=null}}function bn(t,e=null,n=[],r=[],i=null,s=null,o=null){return new wn(t,e,n,r,i,s,o)}function _n(t){const e=M(t);if(null===e.Ie){let t=e.path.canonicalString();null!==e.collectionGroup&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(t=>cn(t)).join(","),t+="|ob:",t+=e.orderBy.map(t=>function(t){return t.field.canonicalString()+t.dir}(t)).join(","),St(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(t=>Le(t)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(t=>Le(t)).join(",")),e.Ie=t}return e.Ie}function En(t,e){if(t.limit!==e.limit)return!1;if(t.orderBy.length!==e.orderBy.length)return!1;for(let n=0;n<t.orderBy.length;n++)if(!tn(t.orderBy[n],e.orderBy[n]))return!1;if(t.filters.length!==e.filters.length)return!1;for(let n=0;n<t.filters.length;n++)if(!un(t.filters[n],e.filters[n]))return!1;return t.collectionGroup===e.collectionGroup&&!!t.path.isEqual(e.path)&&!!Ze(t.startAt,e.startAt)&&Ze(t.endAt,e.endAt)}function Tn(t){return ut.isDocumentKey(t.path)&&null===t.collectionGroup&&0===t.filters.length}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Sn{constructor(t,e=null,n=[],r=[],i=null,s="F",o=null,a=null){this.path=t,this.collectionGroup=e,this.explicitOrderBy=n,this.filters=r,this.limit=i,this.limitType=s,this.startAt=o,this.endAt=a,this.Ee=null,this.de=null,this.Ae=null,this.startAt,this.endAt}}function Cn(t,e,n,r,i,s,o,a){return new Sn(t,e,n,r,i,s,o,a)}function In(t){return new Sn(t)}function xn(t){return 0===t.filters.length&&null===t.limit&&null==t.startAt&&null==t.endAt&&(0===t.explicitOrderBy.length||1===t.explicitOrderBy.length&&t.explicitOrderBy[0].field.isKeyField())}function An(t){return null!==t.collectionGroup}function Dn(t){const e=M(t);if(null===e.Ee){e.Ee=[];const t=new Set;for(const i of e.explicitOrderBy)e.Ee.push(i),t.add(i.field.canonicalString());const n=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc",r=function(t){let e=new oe(ct.comparator);return t.filters.forEach(t=>{t.getFlattenedFilters().forEach(t=>{t.isInequality()&&(e=e.add(t.field))})}),e}(e);r.forEach(r=>{t.has(r.canonicalString())||r.isKeyField()||e.Ee.push(new Je(r,n))}),t.has(ct.keyField().canonicalString())||e.Ee.push(new Je(ct.keyField(),n))}return e.Ee}function kn(t){const e=M(t);return e.de||(e.de=Nn(e,Dn(t))),e.de}function Nn(t,e){if("F"===t.limitType)return bn(t.path,t.collectionGroup,e,t.filters,t.limit,t.startAt,t.endAt);{e=e.map(t=>{const e="desc"===t.dir?"asc":"desc";return new Je(t.field,e)});const n=t.endAt?new Xe(t.endAt.position,t.endAt.inclusive):null,r=t.startAt?new Xe(t.startAt.position,t.startAt.inclusive):null;return bn(t.path,t.collectionGroup,e,t.filters,t.limit,n,r)}}function On(t,e,n){return new Sn(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,n,t.startAt,t.endAt)}function Rn(t,e){return En(kn(t),kn(e))&&t.limitType===e.limitType}function Mn(t){return`${_n(kn(t))}|lt:${t.limitType}`}function Pn(t){return`Query(target=${function(t){let e=t.path.canonicalString();return null!==t.collectionGroup&&(e+=" collectionGroup="+t.collectionGroup),t.filters.length>0&&(e+=`, filters: [${t.filters.map(t=>ln(t)).join(", ")}]`),St(t.limit)||(e+=", limit: "+t.limit),t.orderBy.length>0&&(e+=`, orderBy: [${t.orderBy.map(t=>function(t){return`${t.field.canonicalString()} (${t.dir})`}(t)).join(", ")}]`),t.startAt&&(e+=", startAt: ",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map(t=>Le(t)).join(",")),t.endAt&&(e+=", endAt: ",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map(t=>Le(t)).join(",")),`Target(${e})`}(kn(t))}; limitType=${t.limitType})`}function Ln(t,e){return e.isFoundDocument()&&function(t,e){const n=e.key.path;return null!==t.collectionGroup?e.key.hasCollectionId(t.collectionGroup)&&t.path.isPrefixOf(n):ut.isDocumentKey(t.path)?t.path.isEqual(n):t.path.isImmediateParentOf(n)}(t,e)&&function(t,e){for(const n of Dn(t))if(!n.field.isKeyField()&&null===e.data.field(n.field))return!1;return!0}(t,e)&&function(t,e){for(const n of t.filters)if(!n.matches(e))return!1;return!0}(t,e)&&function(t,e){return!(t.startAt&&!function(t,e,n){const r=Ye(t,e,n);return t.inclusive?r<=0:r<0}(t.startAt,Dn(t),e))&&!(t.endAt&&!function(t,e,n){const r=Ye(t,e,n);return t.inclusive?r>=0:r>0}(t.endAt,Dn(t),e))}(t,e)}function Vn(t){return t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2))}function Fn(t){return(e,n)=>{let r=!1;for(const i of Dn(t)){const t=Un(i,e,n);if(0!==t)return t;r=r||i.field.isKeyField()}return 0}}function Un(t,e,n){const r=t.field.isKeyField()?ut.comparator(e.key,n.key):function(t,e,n){const r=e.data.field(t),i=n.data.field(t);return null!==r&&null!==i?Re(r,i):N(42886)}(t.field,e,n);switch(t.dir){case"asc":return r;case"desc":return-1*r;default:return N(19790,{direction:t.dir})}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bn=new re(ut.comparator);function $n(){return Bn}const zn=new re(ut.comparator);function qn(...t){let e=zn;for(const n of t)e=e.insert(n.key,n);return e}function Kn(t){let e=zn;return t.forEach((t,n)=>e=e.insert(t,n.overlayedDocument)),e}function Hn(){return Qn()}function Gn(){return Qn()}function Qn(){return new jn(t=>t.toString(),(t,e)=>t.isEqual(e))}const Wn=new re(ut.comparator),Xn=new oe(ut.comparator);function Yn(...t){let e=Xn;for(const n of t)e=e.add(n);return e}const Zn=new oe(W);function Jn(){return Zn}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tr(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ct(e)?"-0":e}}function er(t){return{integerValue:""+t}}function nr(t,e){return It(e)?er(e):tr(t,e)}
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rr{constructor(){this._=void 0}}function ir(t,e,n){return t instanceof ar?function(t,e){const n={fields:{[me]:{stringValue:ge},[ve]:{timestampValue:{seconds:t.seconds,nanos:t.nanoseconds}}}};return e&&we(e)&&(e=be(e)),e&&(n.fields[ye]=e),{mapValue:n}}(n,e):t instanceof cr?ur(t,e):t instanceof lr?hr(t,e):function(t,e){const n=or(t,e),r=dr(n)+dr(t.Re);return Ue(n)&&Ue(t.Re)?er(r):tr(t.serializer,r)}(t,e)}function sr(t,e,n){return t instanceof cr?ur(t,e):t instanceof lr?hr(t,e):n}function or(t,e){return t instanceof fr?function(t){return Ue(t)||function(t){return!!t&&"doubleValue"in t}(t)}(e)?e:{integerValue:0}:null}class ar extends rr{}class cr extends rr{constructor(t){super(),this.elements=t}}function ur(t,e){const n=pr(e);for(const r of t.elements)n.some(t=>Ne(t,r))||n.push(r);return{arrayValue:{values:n}}}class lr extends rr{constructor(t){super(),this.elements=t}}function hr(t,e){let n=pr(e);for(const r of t.elements)n=n.filter(t=>!Ne(t,r));return{arrayValue:{values:n}}}class fr extends rr{constructor(t,e){super(),this.serializer=t,this.Re=e}}function dr(t){return de(t.integerValue||t.doubleValue)}function pr(t){return je(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gr(t,e){return t.field.isEqual(e.field)&&function(t,e){return t instanceof cr&&e instanceof cr||t instanceof lr&&e instanceof lr?J(t.elements,e.elements,Ne):t instanceof fr&&e instanceof fr?Ne(t.Re,e.Re):t instanceof ar&&e instanceof ar}(t.transform,e.transform)}class mr{constructor(t,e){this.version=t,this.transformResults=e}}class yr{constructor(t,e){this.updateTime=t,this.exists=e}static none(){return new yr}static exists(t){return new yr(void 0,t)}static updateTime(t){return new yr(t)}get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}function vr(t,e){return void 0!==t.updateTime?e.isFoundDocument()&&e.version.isEqual(t.updateTime):void 0===t.exists||t.exists===e.isFoundDocument()}class wr{}function br(t,e){if(!t.hasLocalMutations||e&&0===e.fields.length)return null;if(null===e)return t.isNoDocument()?new kr(t.key,yr.none()):new Cr(t.key,t.data,yr.none());{const n=t.data,r=Ge.empty();let i=new oe(ct.comparator);for(let t of e.fields)if(!i.has(t)){let e=n.field(t);null===e&&t.length>1&&(t=t.popLast(),e=n.field(t)),null===e?r.delete(t):r.set(t,e),i=i.add(t)}return new Ir(t.key,r,new ce(i.toArray()),yr.none())}}function _r(t,e,n){t instanceof Cr?function(t,e,n){const r=t.value.clone(),i=Ar(t.fieldTransforms,e,n.transformResults);r.setAll(i),e.convertToFoundDocument(n.version,r).setHasCommittedMutations()}(t,e,n):t instanceof Ir?function(t,e,n){if(!vr(t.precondition,e))return void e.convertToUnknownDocument(n.version);const r=Ar(t.fieldTransforms,e,n.transformResults),i=e.data;i.setAll(xr(t)),i.setAll(r),e.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(t,e,n):function(t,e,n){e.convertToNoDocument(n.version).setHasCommittedMutations()}(0,e,n)}function Er(t,e,n,r){return t instanceof Cr?function(t,e,n,r){if(!vr(t.precondition,e))return n;const i=t.value.clone(),s=Dr(t.fieldTransforms,r,e);return i.setAll(s),e.convertToFoundDocument(e.version,i).setHasLocalMutations(),null}(t,e,n,r):t instanceof Ir?function(t,e,n,r){if(!vr(t.precondition,e))return n;const i=Dr(t.fieldTransforms,r,e),s=e.data;return s.setAll(xr(t)),s.setAll(i),e.convertToFoundDocument(e.version,s).setHasLocalMutations(),null===n?null:n.unionWith(t.fieldMask.fields).unionWith(t.fieldTransforms.map(t=>t.field))}(t,e,n,r):function(t,e,n){return vr(t.precondition,e)?(e.convertToNoDocument(e.version).setHasLocalMutations(),null):n}(t,e,n)}function Tr(t,e){let n=null;for(const r of t.fieldTransforms){const t=e.data.field(r.field),i=or(r.transform,t||null);null!=i&&(null===n&&(n=Ge.empty()),n.set(r.field,i))}return n||null}function Sr(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!function(t,e){return void 0===t&&void 0===e||!(!t||!e)&&J(t,e,(t,e)=>gr(t,e))}(t.fieldTransforms,e.fieldTransforms)&&(0===t.type?t.value.isEqual(e.value):1!==t.type||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}class Cr extends wr{constructor(t,e,n,r=[]){super(),this.key=t,this.value=e,this.precondition=n,this.fieldTransforms=r,this.type=0}getFieldMask(){return null}}class Ir extends wr{constructor(t,e,n,r,i=[]){super(),this.key=t,this.data=e,this.fieldMask=n,this.precondition=r,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function xr(t){const e=new Map;return t.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const r=t.data.field(n);e.set(n,r)}}),e}function Ar(t,e,n){const r=new Map;R(t.length===n.length,32656,{Ve:n.length,me:t.length});for(let i=0;i<n.length;i++){const s=t[i],o=s.transform,a=e.data.field(s.field);r.set(s.field,sr(o,a,n[i]))}return r}function Dr(t,e,n){const r=new Map;for(const i of t){const t=i.transform,s=n.data.field(i.field);r.set(i.field,ir(t,s,e))}return r}class kr extends wr{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class Nr extends wr{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Br=new r([4294967295,4294967295],0);function $r(t){const e=G().encode(t),n=new i;return n.update(e),new Uint8Array(n.digest())}function zr(t){const e=new DataView(t.buffer),n=e.getUint32(0,!0),i=e.getUint32(4,!0),s=e.getUint32(8,!0),o=e.getUint32(12,!0);return[new r([n,i],0),new r([s,o],0)]}class qr{constructor(t,e,n){if(this.bitmap=t,this.padding=e,this.hashCount=n,e<0||e>=8)throw new Kr(`Invalid padding: ${e}`);if(n<0)throw new Kr(`Invalid hash count: ${n}`);if(t.length>0&&0===this.hashCount)throw new Kr(`Invalid hash count: ${n}`);if(0===t.length&&0!==e)throw new Kr(`Invalid padding when bitmap length is 0: ${e}`);this.pe=8*t.length-e,this.ye=r.fromNumber(this.pe)}we(t,e,n){let i=t.add(e.multiply(r.fromNumber(n)));return 1===i.compare(Br)&&(i=new r([i.getBits(0),i.getBits(1)],0)),i.modulo(this.ye).toNumber()}be(t){return!!(this.bitmap[Math.floor(t/8)]&1<<t%8)}mightContain(t){if(0===this.pe)return!1;const e=$r(t),[n,r]=zr(e);for(let i=0;i<this.hashCount;i++){const t=this.we(n,r,i);if(!this.be(t))return!1}return!0}static create(t,e,n){const r=t%8==0?0:8-t%8,i=new Uint8Array(Math.ceil(t/8)),s=new qr(i,r,e);return n.forEach(t=>s.insert(t)),s}insert(t){if(0===this.pe)return;const e=$r(t),[n,r]=zr(e);for(let i=0;i<this.hashCount;i++){const t=this.we(n,r,i);this.Se(t)}}Se(t){const e=Math.floor(t/8),n=t%8;this.bitmap[e]|=1<<n}}class Kr extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hr{constructor(t,e,n,r,i){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(t,e,n){const r=new Map;return r.set(t,Gr.createSynthesizedTargetChangeForCurrentChange(t,e,n)),new Hr(rt.min(),r,new re(W),$n(),Yn())}}class Gr{constructor(t,e,n,r,i){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(t,e,n){return new Gr(n,e,Yn(),Yn(),Yn())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qr{constructor(t,e,n,r){this.De=t,this.removedTargetIds=e,this.key=n,this.ve=r}}class Wr{constructor(t,e){this.targetId=t,this.Ce=e}}class Xr{constructor(t,e,n=le.EMPTY_BYTE_STRING,r=null){this.state=t,this.targetIds=e,this.resumeToken=n,this.cause=r}}class Yr{constructor(){this.Fe=0,this.Me=ti(),this.xe=le.EMPTY_BYTE_STRING,this.Oe=!1,this.Ne=!0}get current(){return this.Oe}get resumeToken(){return this.xe}get Be(){return 0!==this.Fe}get Le(){return this.Ne}ke(t){t.approximateByteSize()>0&&(this.Ne=!0,this.xe=t)}qe(){let t=Yn(),e=Yn(),n=Yn();return this.Me.forEach((r,i)=>{switch(i){case 0:t=t.add(r);break;case 2:e=e.add(r);break;case 1:n=n.add(r);break;default:N(38017,{changeType:i})}}),new Gr(this.xe,this.Oe,t,e,n)}Qe(){this.Ne=!1,this.Me=ti()}$e(t,e){this.Ne=!0,this.Me=this.Me.insert(t,e)}Ue(t){this.Ne=!0,this.Me=this.Me.remove(t)}Ke(){this.Fe+=1}We(){this.Fe-=1,R(this.Fe>=0,3241,{Fe:this.Fe})}Ge(){this.Ne=!0,this.Oe=!0}}class Zr{constructor(t){this.ze=t,this.je=new Map,this.He=$n(),this.Je=Jr(),this.Ye=Jr(),this.Ze=new re(W)}Xe(t){for(const e of t.De)t.ve&&t.ve.isFoundDocument()?this.et(e,t.ve):this.tt(e,t.key,t.ve);for(const e of t.removedTargetIds)this.tt(e,t.key,t.ve)}nt(t){this.forEachTarget(t,e=>{const n=this.rt(e);switch(t.state){case 0:this.it(e)&&n.ke(t.resumeToken);break;case 1:n.We(),n.Be||n.Qe(),n.ke(t.resumeToken);break;case 2:n.We(),n.Be||this.removeTarget(e);break;case 3:this.it(e)&&(n.Ge(),n.ke(t.resumeToken));break;case 4:this.it(e)&&(this.st(e),n.ke(t.resumeToken));break;default:N(56790,{state:t.state})}})}forEachTarget(t,e){t.targetIds.length>0?t.targetIds.forEach(e):this.je.forEach((t,n)=>{this.it(n)&&e(n)})}ot(t){const e=t.targetId,n=t.Ce.count,r=this._t(e);if(r){const i=r.target;if(Tn(i))if(0===n){const t=new ut(i.path);this.tt(e,t,We.newNoDocument(t,rt.min()))}else R(1===n,20013,{expectedCount:n});else{const r=this.ut(e);if(r!==n){const n=this.ct(t),i=n?this.lt(n,t,r):1;if(0!==i){this.st(e);const t=2===i?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ze=this.Ze.insert(e,t)}null==jr||jr.ht(function(t,e,n,r,i){var s,o,a,c,u,l;const h={localCacheCount:t,existenceFilterCount:e.count,databaseId:n.database,projectId:n.projectId},f=e.unchangedNames;return f&&(h.bloomFilter={applied:0===i,hashCount:null!==(s=null==f?void 0:f.hashCount)&&void 0!==s?s:0,bitmapLength:null!==(c=null===(a=null===(o=null==f?void 0:f.bits)||void 0===o?void 0:o.bitmap)||void 0===a?void 0:a.length)&&void 0!==c?c:0,padding:null!==(l=null===(u=null==f?void 0:f.bits)||void 0===u?void 0:u.padding)&&void 0!==l?l:0,mightContain:t=>{var e;return null!==(e=null==r?void 0:r.mightContain(t))&&void 0!==e&&e}}),h}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(r,t.Ce,this.ze.Pt(),n,i))}}}}ct(t){const e=t.Ce.unchangedNames;if(!e||!e.bits)return null;const{bits:{bitmap:n="",padding:r=0},hashCount:i=0}=e;let s,o;try{s=pe(n).toUint8Array()}catch(t){if(t instanceof ue)return D("Decoding the base64 bloom filter in existence filter failed ("+t.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw t}try{o=new qr(s,r,i)}catch(t){return D(t instanceof Kr?"BloomFilter error: ":"Applying bloom filter failed: ",t),null}return 0===o.pe?null:o}lt(t,e,n){return e.Ce.count===n-this.Tt(t,e.targetId)?0:2}Tt(t,e){const n=this.ze.getRemoteKeysForTarget(e);let r=0;return n.forEach(n=>{const i=this.ze.Pt(),s=`projects/${i.projectId}/databases/${i.database}/documents/${n.path.canonicalString()}`;t.mightContain(s)||(this.tt(e,n,null),r++)}),r}It(t){const e=new Map;this.je.forEach((n,r)=>{const i=this._t(r);if(i){if(n.current&&Tn(i.target)){const e=new ut(i.target.path);this.Et(e).has(r)||this.dt(r,e)||this.tt(r,e,We.newNoDocument(e,t))}n.Le&&(e.set(r,n.qe()),n.Qe())}});let n=Yn();this.Ye.forEach((t,e)=>{let r=!0;e.forEachWhile(t=>{const e=this._t(t);return!e||"TargetPurposeLimboResolution"===e.purpose||(r=!1,!1)}),r&&(n=n.add(t))}),this.He.forEach((e,n)=>n.setReadTime(t));const r=new Hr(t,e,this.Ze,this.He,n);return this.He=$n(),this.Je=Jr(),this.Ye=Jr(),this.Ze=new re(W),r}et(t,e){if(!this.it(t))return;const n=this.dt(t,e.key)?2:0;this.rt(t).$e(e.key,n),this.He=this.He.insert(e.key,e),this.Je=this.Je.insert(e.key,this.Et(e.key).add(t)),this.Ye=this.Ye.insert(e.key,this.At(e.key).add(t))}tt(t,e,n){if(!this.it(t))return;const r=this.rt(t);this.dt(t,e)?r.$e(e,1):r.Ue(e),this.Ye=this.Ye.insert(e,this.At(e).delete(t)),this.Ye=this.Ye.insert(e,this.At(e).add(t)),n&&(this.He=this.He.insert(e,n))}removeTarget(t){this.je.delete(t)}ut(t){const e=this.rt(t).qe();return this.ze.getRemoteKeysForTarget(t).size+e.addedDocuments.size-e.removedDocuments.size}Ke(t){this.rt(t).Ke()}rt(t){let e=this.je.get(t);return e||(e=new Yr,this.je.set(t,e)),e}At(t){let e=this.Ye.get(t);return e||(e=new oe(W),this.Ye=this.Ye.insert(t,e)),e}Et(t){let e=this.Je.get(t);return e||(e=new oe(W),this.Je=this.Je.insert(t,e)),e}it(t){const e=null!==this._t(t);return e||x("WatchChangeAggregator","Detected inactive target",t),e}_t(t){const e=this.je.get(t);return e&&e.Be?null:this.ze.Rt(t)}st(t){this.je.set(t,new Yr),this.ze.getRemoteKeysForTarget(t).forEach(e=>{this.tt(t,e,null)})}dt(t,e){return this.ze.getRemoteKeysForTarget(t).has(e)}}function Jr(){return new re(ut.comparator)}function ti(){return new re(ut.comparator)}const ei=(()=>{const t={asc:"ASCENDING",desc:"DESCENDING"};return t})(),ni=(()=>{const t={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"};return t})(),ri=(()=>{const t={and:"AND",or:"OR"};return t})();class ii{constructor(t,e){this.databaseId=t,this.useProto3Json=e}}function si(t,e){return t.useProto3Json||St(e)?e:{value:e}}function oi(t,e){return t.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function ai(t,e){return t.useProto3Json?e.toBase64():e.toUint8Array()}function ci(t,e){return oi(t,e.toTimestamp())}function ui(t){return R(!!t,49232),rt.fromTimestamp(function(t){const e=fe(t);return new nt(e.seconds,e.nanos)}(t))}function li(t,e){return hi(t,e).canonicalString()}function hi(t,e){const n=function(t){return new ot(["projects",t.projectId,"databases",t.database])}(t).child("documents");return void 0===e?n:n.child(e)}function fi(t){const e=ot.fromString(t);return R(Pi(e),10190,{key:e.toString()}),e}function di(t,e){return li(t.databaseId,e.path)}function pi(t,e){const n=fi(e);if(n.get(1)!==t.databaseId.projectId)throw new L(P.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+n.get(1)+" vs "+t.databaseId.projectId);if(n.get(3)!==t.databaseId.database)throw new L(P.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+n.get(3)+" vs "+t.databaseId.database);return new ut(vi(n))}function gi(t,e){return li(t.databaseId,e)}function mi(t){const e=fi(t);return 4===e.length?ot.emptyPath():vi(e)}function yi(t){return new ot(["projects",t.databaseId.projectId,"databases",t.databaseId.database]).canonicalString()}function vi(t){return R(t.length>4&&"documents"===t.get(4),29091,{key:t.toString()}),t.popFirst(5)}function wi(t,e,n){return{name:di(t,e),fields:n.value.mapValue.fields}}function bi(t,e){let n;if("targetChange"in e){e.targetChange;const r=function(t){return"NO_CHANGE"===t?0:"ADD"===t?1:"REMOVE"===t?2:"CURRENT"===t?3:"RESET"===t?4:N(39313,{state:t})}(e.targetChange.targetChangeType||"NO_CHANGE"),i=e.targetChange.targetIds||[],s=function(t,e){return t.useProto3Json?(R(void 0===e||"string"==typeof e,58123),le.fromBase64String(e||"")):(R(void 0===e||e instanceof Buffer||e instanceof Uint8Array,16193),le.fromUint8Array(e||new Uint8Array))}(t,e.targetChange.resumeToken),o=e.targetChange.cause,a=o&&function(t){const e=void 0===t.code?P.UNKNOWN:Ur(t.code);return new L(e,t.message||"")}(o);n=new Xr(r,i,s,a||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const i=pi(t,r.document.name),s=ui(r.document.updateTime),o=r.document.createTime?ui(r.document.createTime):rt.min(),a=new Ge({mapValue:{fields:r.document.fields}}),c=We.newFoundDocument(i,s,o,a),u=r.targetIds||[],l=r.removedTargetIds||[];n=new Qr(u,l,c.key,c)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const i=pi(t,r.document),s=r.readTime?ui(r.readTime):rt.min(),o=We.newNoDocument(i,s),a=r.removedTargetIds||[];n=new Qr([],a,o.key,o)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const i=pi(t,r.document),s=r.removedTargetIds||[];n=new Qr([],s,i,null)}else{if(!("filter"in e))return N(11601,{Vt:e});{e.filter;const t=e.filter;t.targetId;const{count:r=0,unchangedNames:i}=t,s=new Pr(r,i),o=t.targetId;n=new Wr(o,s)}}return n}function _i(t,e){let n;if(e instanceof Cr)n={update:wi(t,e.key,e.value)};else if(e instanceof kr)n={delete:di(t,e.key)};else if(e instanceof Ir)n={update:wi(t,e.key,e.data),updateMask:Mi(e.fieldMask)};else{if(!(e instanceof Nr))return N(16599,{ft:e.type});n={verify:di(t,e.key)}}return e.fieldTransforms.length>0&&(n.updateTransforms=e.fieldTransforms.map(t=>function(t,e){const n=e.transform;if(n instanceof ar)return{fieldPath:e.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof cr)return{fieldPath:e.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof lr)return{fieldPath:e.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof fr)return{fieldPath:e.field.canonicalString(),increment:n.Re};throw N(20930,{transform:e.transform})}(0,t))),e.precondition.isNone||(n.currentDocument=function(t,e){return void 0!==e.updateTime?{updateTime:ci(t,e.updateTime)}:void 0!==e.exists?{exists:e.exists}:N(27497)}(t,e.precondition)),n}function Ei(t,e){return t&&t.length>0?(R(void 0!==e,14353),t.map(t=>function(t,e){let n=t.updateTime?ui(t.updateTime):ui(e);return n.isEqual(rt.min())&&(n=ui(e)),new mr(n,t.transformResults||[])}(t,e))):[]}function Ti(t,e){return{documents:[gi(t,e.path)]}}function Si(t,e){const n={structuredQuery:{}},r=e.path;let i;null!==e.collectionGroup?(i=r,n.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(i=r.popLast(),n.structuredQuery.from=[{collectionId:r.lastSegment()}]),n.parent=gi(t,i);const s=function(t){if(0!==t.length)return Ri(rn.create(t,"and"))}(e.filters);s&&(n.structuredQuery.where=s);const o=function(t){if(0!==t.length)return t.map(t=>function(t){return{field:Ni(t.field),direction:Ai(t.dir)}}(t))}(e.orderBy);o&&(n.structuredQuery.orderBy=o);const a=si(t,e.limit);return null!==a&&(n.structuredQuery.limit=a),e.startAt&&(n.structuredQuery.startAt=function(t){return{before:t.inclusive,values:t.position}}(e.startAt)),e.endAt&&(n.structuredQuery.endAt=function(t){return{before:!t.inclusive,values:t.position}}(e.endAt)),{gt:n,parent:i}}function Ci(t){let e=mi(t.parent);const n=t.structuredQuery,r=n.from?n.from.length:0;let i=null;if(r>0){R(1===r,65062);const t=n.from[0];t.allDescendants?i=t.collectionId:e=e.child(t.collectionId)}let s=[];n.where&&(s=function(t){const e=xi(t);return e instanceof rn&&on(e)?e.getFilters():[e]}(n.where));let o=[];n.orderBy&&(o=function(t){return t.map(t=>function(t){return new Je(Oi(t.field),function(t){switch(t){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(t.direction))}(t))}(n.orderBy));let a=null;n.limit&&(a=function(t){let e;return e="object"==typeof t?t.value:t,St(e)?null:e}(n.limit));let c=null;n.startAt&&(c=function(t){const e=!!t.before,n=t.values||[];return new Xe(n,e)}(n.startAt));let u=null;return n.endAt&&(u=function(t){const e=!t.before,n=t.values||[];return new Xe(n,e)}(n.endAt)),Cn(e,i,o,s,a,"F",c,u)}function Ii(t,e){const n=function(t){switch(t){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return N(28987,{purpose:t})}}(e.purpose);return null==n?null:{"goog-listen-tags":n}}function xi(t){return void 0!==t.unaryFilter?function(t){switch(t.unaryFilter.op){case"IS_NAN":const e=Oi(t.unaryFilter.field);return nn.create(e,"==",{doubleValue:NaN});case"IS_NULL":const n=Oi(t.unaryFilter.field);return nn.create(n,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const r=Oi(t.unaryFilter.field);return nn.create(r,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const i=Oi(t.unaryFilter.field);return nn.create(i,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return N(61313);default:return N(60726)}}(t):void 0!==t.fieldFilter?function(t){return nn.create(Oi(t.fieldFilter.field),function(t){switch(t){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return N(58110);default:return N(50506)}}(t.fieldFilter.op),t.fieldFilter.value)}(t):void 0!==t.compositeFilter?function(t){return rn.create(t.compositeFilter.filters.map(t=>xi(t)),function(t){switch(t){case"AND":return"and";case"OR":return"or";default:return N(1026)}}(t.compositeFilter.op))}(t):N(30097,{filter:t})}function Ai(t){return ei[t]}function Di(t){return ni[t]}function ki(t){return ri[t]}function Ni(t){return{fieldPath:t.canonicalString()}}function Oi(t){return ct.fromServerFormat(t.fieldPath)}function Ri(t){return t instanceof nn?function(t){if("=="===t.op){if($e(t.value))return{unaryFilter:{field:Ni(t.field),op:"IS_NAN"}};if(Be(t.value))return{unaryFilter:{field:Ni(t.field),op:"IS_NULL"}}}else if("!="===t.op){if($e(t.value))return{unaryFilter:{field:Ni(t.field),op:"IS_NOT_NAN"}};if(Be(t.value))return{unaryFilter:{field:Ni(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Ni(t.field),op:Di(t.op),value:t.value}}}(t):t instanceof rn?function(t){const e=t.getFilters().map(t=>Ri(t));return 1===e.length?e[0]:{compositeFilter:{op:ki(t.op),filters:e}}}(t):N(54877,{filter:t})}function Mi(t){const e=[];return t.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function Pi(t){return t.length>=4&&"projects"===t.get(0)&&"databases"===t.get(2)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vi{constructor(t){this.wt=t}}function Fi(t){const e=Ci({parent:t.parent,structuredQuery:t.structuredQuery});return"LAST"===t.limitType?On(e,e.limit,"L"):e}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class ji{constructor(){this.Cn=new Bi}addToCollectionParentIndex(t,e){return this.Cn.add(e),wt.resolve()}getCollectionParents(t,e){return wt.resolve(this.Cn.getEntries(e))}addFieldIndex(t,e){return wt.resolve()}deleteFieldIndex(t,e){return wt.resolve()}deleteAllFieldIndexes(t){return wt.resolve()}createTargetIndexes(t,e){return wt.resolve()}getDocumentsMatchingTarget(t,e){return wt.resolve(null)}getIndexType(t,e){return wt.resolve(0)}getFieldIndexes(t,e){return wt.resolve([])}getNextCollectionGroupToUpdate(t){return wt.resolve(null)}getMinOffset(t,e){return wt.resolve(pt.min())}getMinOffsetFromCollectionGroup(t,e){return wt.resolve(pt.min())}updateCollectionGroup(t,e,n){return wt.resolve()}updateIndexEntries(t,e){return wt.resolve()}}class Bi{constructor(){this.index={}}add(t){const e=t.lastSegment(),n=t.popLast(),r=this.index[e]||new oe(ot.comparator),i=!r.has(n);return this.index[e]=r.add(n),i}has(t){const e=t.lastSegment(),n=t.popLast(),r=this.index[e];return r&&r.has(n)}getEntries(t){return(this.index[t]||new oe(ot.comparator)).toArray()}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const $i={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0},zi=41943040;class qi{static withCacheSize(t){return new qi(t,qi.DEFAULT_COLLECTION_PERCENTILE,qi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(t,e,n){this.cacheSizeCollectionThreshold=t,this.percentileToCollect=e,this.maximumSequenceNumbersToCollect=n}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */qi.DEFAULT_COLLECTION_PERCENTILE=10,qi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,qi.DEFAULT=new qi(zi,qi.DEFAULT_COLLECTION_PERCENTILE,qi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),qi.DISABLED=new qi(-1,0,0);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Hi="LruGarbageCollector",Gi=1048576;function Qi([t,e],[n,r]){const i=W(t,n);return 0===i?W(e,r):i}class Wi{constructor(t){this.Er=t,this.buffer=new oe(Qi),this.dr=0}Ar(){return++this.dr}Rr(t){const e=[t,this.Ar()];if(this.buffer.size<this.Er)this.buffer=this.buffer.add(e);else{const t=this.buffer.last();Qi(e,t)<0&&(this.buffer=this.buffer.delete(t).add(e))}}get maxValue(){return this.buffer.last()[0]}}class Xi{constructor(t,e,n){this.garbageCollector=t,this.asyncQueue=e,this.localStore=n,this.Vr=null}start(){-1!==this.garbageCollector.params.cacheSizeCollectionThreshold&&this.mr(6e4)}stop(){this.Vr&&(this.Vr.cancel(),this.Vr=null)}get started(){return null!==this.Vr}mr(t){x(Hi,`Garbage collection scheduled in ${t}ms`),this.Vr=this.asyncQueue.enqueueAfterDelay("lru_garbage_collection",t,async()=>{this.Vr=null;try{await this.localStore.collectGarbage(this.garbageCollector)}catch(t){_t(t)?x(Hi,"Ignoring IndexedDB error during garbage collection: ",t):await vt(t)}await this.mr(3e5)})}}class Yi{constructor(t,e){this.gr=t,this.params=e}calculateTargetCount(t,e){return this.gr.pr(t).next(t=>Math.floor(e/100*t))}nthSequenceNumber(t,e){if(0===e)return wt.resolve(Et.le);const n=new Wi(e);return this.gr.forEachTarget(t,t=>n.Rr(t.sequenceNumber)).next(()=>this.gr.yr(t,t=>n.Rr(t))).next(()=>n.maxValue)}removeTargets(t,e,n){return this.gr.removeTargets(t,e,n)}removeOrphanedDocuments(t,e){return this.gr.removeOrphanedDocuments(t,e)}collect(t,e){return-1===this.params.cacheSizeCollectionThreshold?(x("LruGarbageCollector","Garbage collection skipped; disabled"),wt.resolve($i)):this.getCacheSize(t).next(n=>n<this.params.cacheSizeCollectionThreshold?(x("LruGarbageCollector",`Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`),$i):this.wr(t,e))}getCacheSize(t){return this.gr.getCacheSize(t)}wr(t,e){let n,r,i,s,o,c,u;const l=Date.now();return this.calculateTargetCount(t,this.params.percentileToCollect).next(e=>(e>this.params.maximumSequenceNumbersToCollect?(x("LruGarbageCollector",`Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${e}`),r=this.params.maximumSequenceNumbersToCollect):r=e,s=Date.now(),this.nthSequenceNumber(t,r))).next(r=>(n=r,o=Date.now(),this.removeTargets(t,n,e))).next(e=>(i=e,c=Date.now(),this.removeOrphanedDocuments(t,n))).next(t=>(u=Date.now(),I()<=a.$b.DEBUG&&x("LruGarbageCollector",`LRU Garbage Collection\n\tCounted targets in ${s-l}ms\n\tDetermined least recently used ${r} in `+(o-s)+"ms\n"+`\tRemoved ${i} targets in `+(c-o)+"ms\n"+`\tRemoved ${t} documents in `+(u-c)+"ms\n"+`Total Duration: ${u-l}ms`),wt.resolve({didRun:!0,sequenceNumbersCollected:r,targetsRemoved:i,documentsRemoved:t})))}}function Zi(t,e){return new Yi(t,e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ji{constructor(){this.changes=new jn(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,We.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const n=this.changes.get(e);return void 0!==n?wt.resolve(n):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class es{constructor(t,e,n,r){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=n,this.indexManager=r}getDocument(t,e){let n=null;return this.documentOverlayCache.getOverlay(t,e).next(r=>(n=r,this.remoteDocumentCache.getEntry(t,e))).next(t=>(null!==n&&Er(n.mutation,t,ce.empty(),nt.now()),t))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(e=>this.getLocalViewOfDocuments(t,e,Yn()).next(()=>e))}getLocalViewOfDocuments(t,e,n=Yn()){const r=Hn();return this.populateOverlays(t,r,e).next(()=>this.computeViews(t,e,r,n).next(t=>{let e=qn();return t.forEach((t,n)=>{e=e.insert(t,n.overlayedDocument)}),e}))}getOverlayedDocuments(t,e){const n=Hn();return this.populateOverlays(t,n,e).next(()=>this.computeViews(t,e,n,Yn()))}populateOverlays(t,e,n){const r=[];return n.forEach(t=>{e.has(t)||r.push(t)}),this.documentOverlayCache.getOverlays(t,r).next(t=>{t.forEach((t,n)=>{e.set(t,n)})})}computeViews(t,e,n,r){let i=$n();const s=Qn(),o=function(){return Qn()}();return e.forEach((t,e)=>{const o=n.get(e.key);r.has(e.key)&&(void 0===o||o.mutation instanceof Ir)?i=i.insert(e.key,e):void 0!==o?(s.set(e.key,o.mutation.getFieldMask()),Er(o.mutation,e,o.mutation.getFieldMask(),nt.now())):s.set(e.key,ce.empty())}),this.recalculateAndSaveOverlays(t,i).next(t=>(t.forEach((t,e)=>s.set(t,e)),e.forEach((t,e)=>{var n;return o.set(t,new ts(e,null!==(n=s.get(t))&&void 0!==n?n:null))}),o))}recalculateAndSaveOverlays(t,e){const n=Qn();let r=new re((t,e)=>t-e),i=Yn();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(t=>{for(const i of t)i.keys().forEach(t=>{const s=e.get(t);if(null===s)return;let o=n.get(t)||ce.empty();o=i.applyToLocalView(s,o),n.set(t,o);const a=(r.get(i.batchId)||Yn()).add(t);r=r.insert(i.batchId,a)})}).next(()=>{const s=[],o=r.getReverseIterator();for(;o.hasNext();){const r=o.getNext(),a=r.key,c=r.value,u=Gn();c.forEach(t=>{if(!i.has(t)){const r=br(e.get(t),n.get(t));null!==r&&u.set(t,r),i=i.add(t)}}),s.push(this.documentOverlayCache.saveOverlays(t,a,u))}return wt.waitFor(s)}).next(()=>n)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(e=>this.recalculateAndSaveOverlays(t,e))}getDocumentsMatchingQuery(t,e,n,r){return function(t){return ut.isDocumentKey(t.path)&&null===t.collectionGroup&&0===t.filters.length}(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):An(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,n,r):this.getDocumentsMatchingCollectionQuery(t,e,n,r)}getNextDocuments(t,e,n,r){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,n,r).next(i=>{const s=r-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,n.largestBatchId,r-i.size):wt.resolve(Hn());let o=lt,a=i;return s.next(e=>wt.forEach(e,(e,n)=>(o<n.largestBatchId&&(o=n.largestBatchId),i.get(e)?wt.resolve():this.remoteDocumentCache.getEntry(t,e).next(t=>{a=a.insert(e,t)}))).next(()=>this.populateOverlays(t,e,i)).next(()=>this.computeViews(t,a,e,Yn())).next(t=>({batchId:o,changes:Kn(t)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new ut(e)).next(t=>{let e=qn();return t.isFoundDocument()&&(e=e.insert(t.key,t)),e})}getDocumentsMatchingCollectionGroupQuery(t,e,n,r){const i=e.collectionGroup;let s=qn();return this.indexManager.getCollectionParents(t,i).next(o=>wt.forEach(o,o=>{const a=function(t,e){return new Sn(e,null,t.explicitOrderBy.slice(),t.filters.slice(),t.limit,t.limitType,t.startAt,t.endAt)}(e,o.child(i));return this.getDocumentsMatchingCollectionQuery(t,a,n,r).next(t=>{t.forEach((t,e)=>{s=s.insert(t,e)})})}).next(()=>s))}getDocumentsMatchingCollectionQuery(t,e,n,r){let i;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,n.largestBatchId).next(s=>(i=s,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,n,i,r))).next(t=>{i.forEach((e,n)=>{const r=n.getKey();null===t.get(r)&&(t=t.insert(r,We.newInvalidDocument(r)))});let n=qn();return t.forEach((t,r)=>{const s=i.get(t);void 0!==s&&Er(s.mutation,r,ce.empty(),nt.now()),Ln(e,r)&&(n=n.insert(t,r))}),n})}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ns{constructor(t){this.serializer=t,this.kr=new Map,this.qr=new Map}getBundleMetadata(t,e){return wt.resolve(this.kr.get(e))}saveBundleMetadata(t,e){return this.kr.set(e.id,function(t){return{id:t.id,version:t.version,createTime:ui(t.createTime)}}(e)),wt.resolve()}getNamedQuery(t,e){return wt.resolve(this.qr.get(e))}saveNamedQuery(t,e){return this.qr.set(e.name,function(t){return{name:t.name,query:Fi(t.bundledQuery),readTime:ui(t.readTime)}}(e)),wt.resolve()}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rs{constructor(){this.overlays=new re(ut.comparator),this.Qr=new Map}getOverlay(t,e){return wt.resolve(this.overlays.get(e))}getOverlays(t,e){const n=Hn();return wt.forEach(e,e=>this.getOverlay(t,e).next(t=>{null!==t&&n.set(e,t)})).next(()=>n)}saveOverlays(t,e,n){return n.forEach((n,r)=>{this.St(t,e,r)}),wt.resolve()}removeOverlaysForBatchId(t,e,n){const r=this.Qr.get(n);return void 0!==r&&(r.forEach(t=>this.overlays=this.overlays.remove(t)),this.Qr.delete(n)),wt.resolve()}getOverlaysForCollection(t,e,n){const r=Hn(),i=e.length+1,s=new ut(e.child("")),o=this.overlays.getIteratorFrom(s);for(;o.hasNext();){const t=o.getNext().value,s=t.getKey();if(!e.isPrefixOf(s.path))break;s.path.length===i&&t.largestBatchId>n&&r.set(t.getKey(),t)}return wt.resolve(r)}getOverlaysForCollectionGroup(t,e,n,r){let i=new re((t,e)=>t-e);const s=this.overlays.getIterator();for(;s.hasNext();){const t=s.getNext().value;if(t.getKey().getCollectionGroup()===e&&t.largestBatchId>n){let e=i.get(t.largestBatchId);null===e&&(e=Hn(),i=i.insert(t.largestBatchId,e)),e.set(t.getKey(),t)}}const o=Hn(),a=i.getIterator();for(;a.hasNext();)if(a.getNext().value.forEach((t,e)=>o.set(t,e)),o.size()>=r)break;return wt.resolve(o)}St(t,e,n){const r=this.overlays.get(n.key);if(null!==r){const t=this.Qr.get(r.largestBatchId).delete(n.key);this.Qr.set(r.largestBatchId,t)}this.overlays=this.overlays.insert(n.key,new Mr(e,n));let i=this.Qr.get(e);void 0===i&&(i=Yn(),this.Qr.set(e,i)),this.Qr.set(e,i.add(n.key))}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class is{constructor(){this.sessionToken=le.EMPTY_BYTE_STRING}getSessionToken(t){return wt.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,wt.resolve()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ss{constructor(){this.$r=new oe(os.Ur),this.Kr=new oe(os.Wr)}isEmpty(){return this.$r.isEmpty()}addReference(t,e){const n=new os(t,e);this.$r=this.$r.add(n),this.Kr=this.Kr.add(n)}Gr(t,e){t.forEach(t=>this.addReference(t,e))}removeReference(t,e){this.zr(new os(t,e))}jr(t,e){t.forEach(t=>this.removeReference(t,e))}Hr(t){const e=new ut(new ot([])),n=new os(e,t),r=new os(e,t+1),i=[];return this.Kr.forEachInRange([n,r],t=>{this.zr(t),i.push(t.key)}),i}Jr(){this.$r.forEach(t=>this.zr(t))}zr(t){this.$r=this.$r.delete(t),this.Kr=this.Kr.delete(t)}Yr(t){const e=new ut(new ot([])),n=new os(e,t),r=new os(e,t+1);let i=Yn();return this.Kr.forEachInRange([n,r],t=>{i=i.add(t.key)}),i}containsKey(t){const e=new os(t,0),n=this.$r.firstAfterOrEqual(e);return null!==n&&t.isEqual(n.key)}}class os{constructor(t,e){this.key=t,this.Zr=e}static Ur(t,e){return ut.comparator(t.key,e.key)||W(t.Zr,e.Zr)}static Wr(t,e){return W(t.Zr,e.Zr)||ut.comparator(t.key,e.key)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class as{constructor(t,e){this.indexManager=t,this.referenceDelegate=e,this.mutationQueue=[],this.nr=1,this.Xr=new oe(os.Ur)}checkEmpty(t){return wt.resolve(0===this.mutationQueue.length)}addMutationBatch(t,e,n,r){const i=this.nr;this.nr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const s=new Or(i,e,n,r);this.mutationQueue.push(s);for(const o of r)this.Xr=this.Xr.add(new os(o.key,i)),this.indexManager.addToCollectionParentIndex(t,o.key.path.popLast());return wt.resolve(s)}lookupMutationBatch(t,e){return wt.resolve(this.ei(e))}getNextMutationBatchAfterBatchId(t,e){const n=e+1,r=this.ti(n),i=r<0?0:r;return wt.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return wt.resolve(0===this.mutationQueue.length?Tt:this.nr-1)}getAllMutationBatches(t){return wt.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(t,e){const n=new os(e,0),r=new os(e,Number.POSITIVE_INFINITY),i=[];return this.Xr.forEachInRange([n,r],t=>{const e=this.ei(t.Zr);i.push(e)}),wt.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(t,e){let n=new oe(W);return e.forEach(t=>{const e=new os(t,0),r=new os(t,Number.POSITIVE_INFINITY);this.Xr.forEachInRange([e,r],t=>{n=n.add(t.Zr)})}),wt.resolve(this.ni(n))}getAllMutationBatchesAffectingQuery(t,e){const n=e.path,r=n.length+1;let i=n;ut.isDocumentKey(i)||(i=i.child(""));const s=new os(new ut(i),0);let o=new oe(W);return this.Xr.forEachWhile(t=>{const e=t.key.path;return!!n.isPrefixOf(e)&&(e.length===r&&(o=o.add(t.Zr)),!0)},s),wt.resolve(this.ni(o))}ni(t){const e=[];return t.forEach(t=>{const n=this.ei(t);null!==n&&e.push(n)}),e}removeMutationBatch(t,e){R(0===this.ri(e.batchId,"removed"),55003),this.mutationQueue.shift();let n=this.Xr;return wt.forEach(e.mutations,r=>{const i=new os(r.key,e.batchId);return n=n.delete(i),this.referenceDelegate.markPotentiallyOrphaned(t,r.key)}).next(()=>{this.Xr=n})}sr(t){}containsKey(t,e){const n=new os(e,0),r=this.Xr.firstAfterOrEqual(n);return wt.resolve(e.isEqual(r&&r.key))}performConsistencyCheck(t){return this.mutationQueue.length,wt.resolve()}ri(t,e){return this.ti(t)}ti(t){return 0===this.mutationQueue.length?0:t-this.mutationQueue[0].batchId}ei(t){const e=this.ti(t);return e<0||e>=this.mutationQueue.length?null:this.mutationQueue[e]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cs{constructor(t){this.ii=t,this.docs=function(){return new re(ut.comparator)}(),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const n=e.key,r=this.docs.get(n),i=r?r.size:0,s=this.ii(e);return this.docs=this.docs.insert(n,{document:e.mutableCopy(),size:s}),this.size+=s-i,this.indexManager.addToCollectionParentIndex(t,n.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const n=this.docs.get(e);return wt.resolve(n?n.document.mutableCopy():We.newInvalidDocument(e))}getEntries(t,e){let n=$n();return e.forEach(t=>{const e=this.docs.get(t);n=n.insert(t,e?e.document.mutableCopy():We.newInvalidDocument(t))}),wt.resolve(n)}getDocumentsMatchingQuery(t,e,n,r){let i=$n();const s=e.path,o=new ut(s.child("__id-9223372036854775808__")),a=this.docs.getIteratorFrom(o);for(;a.hasNext();){const{key:t,value:{document:o}}=a.getNext();if(!s.isPrefixOf(t.path))break;t.path.length>s.length+1||gt(dt(o),n)<=0||(r.has(o.key)||Ln(e,o))&&(i=i.insert(o.key,o.mutableCopy()))}return wt.resolve(i)}getAllFromCollectionGroup(t,e,n,r){N(9500)}si(t,e){return wt.forEach(this.docs,t=>e(t))}newChangeBuffer(t){return new us(this)}getSize(t){return wt.resolve(this.size)}}class us extends Ji{constructor(t){super(),this.Br=t}applyChanges(t){const e=[];return this.changes.forEach((n,r)=>{r.isValidDocument()?e.push(this.Br.addEntry(t,r)):this.Br.removeEntry(n)}),wt.waitFor(e)}getFromCache(t,e){return this.Br.getEntry(t,e)}getAllFromCache(t,e){return this.Br.getEntries(t,e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class gs{constructor(t,e,n,r){this.targetId=t,this.fromCache=e,this.ds=n,this.As=r}static Rs(t,e){let n=Yn(),r=Yn();for(const i of e.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:r=r.add(i.doc.key)}return new gs(t,e.fromCache,n,r)}}
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ys{constructor(){this.Vs=!1,this.fs=!1,this.gs=100,this.ps=function(){return(0,c.nr)()?8:bt((0,c.ZQ)())>0?6:4}()}initialize(t,e){this.ys=t,this.indexManager=e,this.Vs=!0}getDocumentsMatchingQuery(t,e,n,r){const i={result:null};return this.ws(t,e).next(t=>{i.result=t}).next(()=>{if(!i.result)return this.bs(t,e,r,n).next(t=>{i.result=t})}).next(()=>{if(i.result)return;const n=new ms;return this.Ss(t,e,n).next(r=>{if(i.result=r,this.fs)return this.Ds(t,e,n,r.size)})}).next(()=>i.result)}Ds(t,e,n,r){return n.documentReadCount<this.gs?(I()<=a.$b.DEBUG&&x("QueryEngine","SDK will not create cache indexes for query:",Pn(e),"since it only creates cache indexes for collection contains","more than or equal to",this.gs,"documents"),wt.resolve()):(I()<=a.$b.DEBUG&&x("QueryEngine","Query:",Pn(e),"scans",n.documentReadCount,"local documents and returns",r,"documents as results."),n.documentReadCount>this.ps*r?(I()<=a.$b.DEBUG&&x("QueryEngine","The SDK decides to create cache indexes for query:",Pn(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,kn(e))):wt.resolve())}ws(t,e){if(xn(e))return wt.resolve(null);let n=kn(e);return this.indexManager.getIndexType(t,n).next(r=>0===r?null:(null!==e.limit&&1===r&&(e=On(e,null,"F"),n=kn(e)),this.indexManager.getDocumentsMatchingTarget(t,n).next(r=>{const i=Yn(...r);return this.ys.getDocuments(t,i).next(r=>this.indexManager.getMinOffset(t,n).next(n=>{const s=this.vs(e,r);return this.Cs(e,s,i,n.readTime)?this.ws(t,On(e,null,"F")):this.Fs(t,s,e,n)}))})))}bs(t,e,n,r){return xn(e)||r.isEqual(rt.min())?wt.resolve(null):this.ys.getDocuments(t,n).next(i=>{const s=this.vs(e,i);return this.Cs(e,s,n,r)?wt.resolve(null):(I()<=a.$b.DEBUG&&x("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),Pn(e)),this.Fs(t,s,e,ft(r,lt)).next(t=>t))})}vs(t,e){let n=new oe(Fn(t));return e.forEach((e,r)=>{Ln(t,r)&&(n=n.add(r))}),n}Cs(t,e,n,r){if(null===t.limit)return!1;if(n.size!==e.size)return!0;const i="F"===t.limitType?e.last():e.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}Ss(t,e,n){return I()<=a.$b.DEBUG&&x("QueryEngine","Using full collection scan to execute query:",Pn(e)),this.ys.getDocumentsMatchingQuery(t,e,pt.min(),n)}Fs(t,e,n,r){return this.ys.getDocumentsMatchingQuery(t,n,r).next(t=>(e.forEach(e=>{t=t.insert(e.key,e)}),t))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vs="LocalStore",ws=3e8;class bs{constructor(t,e,n,r){this.persistence=t,this.Ms=e,this.serializer=r,this.xs=new re(W),this.Os=new jn(t=>_n(t),En),this.Ns=new Map,this.Bs=t.getRemoteDocumentCache(),this.Ti=t.getTargetCache(),this.Ei=t.getBundleCache(),this.Ls(n)}Ls(t){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(t),this.indexManager=this.persistence.getIndexManager(t),this.mutationQueue=this.persistence.getMutationQueue(t,this.indexManager),this.localDocuments=new es(this.Bs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Bs.setIndexManager(this.indexManager),this.Ms.initialize(this.localDocuments,this.indexManager)}collectGarbage(t){return this.persistence.runTransaction("Collect garbage","readwrite-primary",e=>t.collect(e,this.xs))}}function _s(t,e,n,r){return new bs(t,e,n,r)}async function Es(t,e){const n=M(t);return await n.persistence.runTransaction("Handle user change","readonly",t=>{let r;return n.mutationQueue.getAllMutationBatches(t).next(i=>(r=i,n.Ls(e),n.mutationQueue.getAllMutationBatches(t))).next(e=>{const i=[],s=[];let o=Yn();for(const t of r){i.push(t.batchId);for(const e of t.mutations)o=o.add(e.key)}for(const t of e){s.push(t.batchId);for(const e of t.mutations)o=o.add(e.key)}return n.localDocuments.getDocuments(t,o).next(t=>({ks:t,removedBatchIds:i,addedBatchIds:s}))})})}function Ts(t,e){const n=M(t);return n.persistence.runTransaction("Acknowledge batch","readwrite-primary",t=>{const r=e.batch.keys(),i=n.Bs.newChangeBuffer({trackRemovals:!0});return function(t,e,n,r){const i=n.batch,s=i.keys();let o=wt.resolve();return s.forEach(t=>{o=o.next(()=>r.getEntry(e,t)).next(e=>{const s=n.docVersions.get(t);R(null!==s,48541),e.version.compareTo(s)<0&&(i.applyToRemoteDocument(e,n),e.isValidDocument()&&(e.setReadTime(n.commitVersion),r.addEntry(e)))})}),o.next(()=>t.mutationQueue.removeMutationBatch(e,i))}(n,t,e,i).next(()=>i.apply(t)).next(()=>n.mutationQueue.performConsistencyCheck(t)).next(()=>n.documentOverlayCache.removeOverlaysForBatchId(t,r,e.batch.batchId)).next(()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(t,function(t){let e=Yn();for(let n=0;n<t.mutationResults.length;++n)t.mutationResults[n].transformResults.length>0&&(e=e.add(t.batch.mutations[n].key));return e}(e))).next(()=>n.localDocuments.getDocuments(t,r))})}function Ss(t){const e=M(t);return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Ti.getLastRemoteSnapshotVersion(t))}function Cs(t,e){const n=M(t),r=e.snapshotVersion;let i=n.xs;return n.persistence.runTransaction("Apply remote event","readwrite-primary",t=>{const s=n.Bs.newChangeBuffer({trackRemovals:!0});i=n.xs;const o=[];e.targetChanges.forEach((s,a)=>{const c=i.get(a);if(!c)return;o.push(n.Ti.removeMatchingKeys(t,s.removedDocuments,a).next(()=>n.Ti.addMatchingKeys(t,s.addedDocuments,a)));let u=c.withSequenceNumber(t.currentSequenceNumber);null!==e.targetMismatches.get(a)?u=u.withResumeToken(le.EMPTY_BYTE_STRING,rt.min()).withLastLimboFreeSnapshotVersion(rt.min()):s.resumeToken.approximateByteSize()>0&&(u=u.withResumeToken(s.resumeToken,r)),i=i.insert(a,u),function(t,e,n){if(0===t.resumeToken.approximateByteSize())return!0;const r=e.snapshotVersion.toMicroseconds()-t.snapshotVersion.toMicroseconds();if(r>=ws)return!0;const i=n.addedDocuments.size+n.modifiedDocuments.size+n.removedDocuments.size;return i>0}(c,u,s)&&o.push(n.Ti.updateTargetData(t,u))});let a=$n(),c=Yn();if(e.documentUpdates.forEach(r=>{e.resolvedLimboDocuments.has(r)&&o.push(n.persistence.referenceDelegate.updateLimboDocument(t,r))}),o.push(Is(t,s,e.documentUpdates).next(t=>{a=t.qs,c=t.Qs})),!r.isEqual(rt.min())){const e=n.Ti.getLastRemoteSnapshotVersion(t).next(e=>n.Ti.setTargetsMetadata(t,t.currentSequenceNumber,r));o.push(e)}return wt.waitFor(o).next(()=>s.apply(t)).next(()=>n.localDocuments.getLocalViewOfDocuments(t,a,c)).next(()=>a)}).then(t=>(n.xs=i,t))}function Is(t,e,n){let r=Yn(),i=Yn();return n.forEach(t=>r=r.add(t)),e.getEntries(t,r).next(t=>{let r=$n();return n.forEach((n,s)=>{const o=t.get(n);s.isFoundDocument()!==o.isFoundDocument()&&(i=i.add(n)),s.isNoDocument()&&s.version.isEqual(rt.min())?(e.removeEntry(n,s.readTime),r=r.insert(n,s)):!o.isValidDocument()||s.version.compareTo(o.version)>0||0===s.version.compareTo(o.version)&&o.hasPendingWrites?(e.addEntry(s),r=r.insert(n,s)):x(vs,"Ignoring outdated watch update for ",n,". Current version:",o.version," Watch version:",s.version)}),{qs:r,Qs:i}})}function xs(t,e){const n=M(t);return n.persistence.runTransaction("Get next mutation batch","readonly",t=>(void 0===e&&(e=Tt),n.mutationQueue.getNextMutationBatchAfterBatchId(t,e)))}function As(t,e){const n=M(t);return n.persistence.runTransaction("Allocate target","readwrite",t=>{let r;return n.Ti.getTargetData(t,e).next(i=>i?(r=i,wt.resolve(r)):n.Ti.allocateTargetId(t).next(i=>(r=new Li(e,i,"TargetPurposeListen",t.currentSequenceNumber),n.Ti.addTargetData(t,r).next(()=>r))))}).then(t=>{const r=n.xs.get(t.targetId);return(null===r||t.snapshotVersion.compareTo(r.snapshotVersion)>0)&&(n.xs=n.xs.insert(t.targetId,t),n.Os.set(e,t.targetId)),t})}async function Ds(t,e,n){const r=M(t),i=r.xs.get(e),s=n?"readwrite":"readwrite-primary";try{n||await r.persistence.runTransaction("Release target",s,t=>r.persistence.referenceDelegate.removeTarget(t,i))}catch(t){if(!_t(t))throw t;x(vs,`Failed to update sequence numbers for target ${e}: ${t}`)}r.xs=r.xs.remove(e),r.Os.delete(i.target)}function ks(t,e,n){const r=M(t);let i=rt.min(),s=Yn();return r.persistence.runTransaction("Execute query","readwrite",t=>function(t,e,n){const r=M(t),i=r.Os.get(n);return void 0!==i?wt.resolve(r.xs.get(i)):r.Ti.getTargetData(e,n)}(r,t,kn(e)).next(e=>{if(e)return i=e.lastLimboFreeSnapshotVersion,r.Ti.getMatchingKeysForTargetId(t,e.targetId).next(t=>{s=t})}).next(()=>r.Ms.getDocumentsMatchingQuery(t,e,n?i:rt.min(),n?s:Yn())).next(t=>(Ns(r,Vn(e),t),{documents:t,$s:s})))}function Ns(t,e,n){let r=t.Ns.get(e)||rt.min();n.forEach((t,e)=>{e.readTime.compareTo(r)>0&&(r=e.readTime)}),t.Ns.set(e,r)}class Os{constructor(){this.activeTargetIds=Jn()}js(t){this.activeTargetIds=this.activeTargetIds.add(t)}Hs(t){this.activeTargetIds=this.activeTargetIds.delete(t)}zs(){const t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class Rs{constructor(){this.xo=new Os,this.Oo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){}updateMutationState(t,e,n){}addLocalQueryTarget(t,e=!0){return e&&this.xo.js(t),this.Oo[t]||"not-current"}updateQueryState(t,e,n){this.Oo[t]=e}removeLocalQueryTarget(t){this.xo.Hs(t)}isLocalQueryTarget(t){return this.xo.activeTargetIds.has(t)}clearQueryState(t){delete this.Oo[t]}getAllActiveQueryTargets(){return this.xo.activeTargetIds}isActiveQueryTarget(t){return this.xo.activeTargetIds.has(t)}start(){return this.xo=new Os,Promise.resolve()}handleUserChange(t,e,n){}setOnlineState(t){}shutdown(){}writeSequenceNumber(t){}notifyBundleLoaded(t){}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ps="ConnectivityMonitor";class Ls{constructor(){this.Bo=()=>this.Lo(),this.ko=()=>this.qo(),this.Qo=[],this.$o()}No(t){this.Qo.push(t)}shutdown(){window.removeEventListener("online",this.Bo),window.removeEventListener("offline",this.ko)}$o(){window.addEventListener("online",this.Bo),window.addEventListener("offline",this.ko)}Lo(){x(Ps,"Network connectivity changed: AVAILABLE");for(const t of this.Qo)t(0)}qo(){x(Ps,"Network connectivity changed: UNAVAILABLE");for(const t of this.Qo)t(1)}static C(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $s{constructor(t){this.Zo=t.Zo,this.Xo=t.Xo}e_(t){this.t_=t}n_(t){this.r_=t}i_(t){this.s_=t}onMessage(t){this.o_=t}close(){this.Xo()}send(t){this.Zo(t)}__(){this.t_()}a_(){this.r_()}u_(t){this.s_(t)}c_(t){this.o_(t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zs="WebChannelConnection";class qs extends Bs{constructor(t){super(t),this.l_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,e,n,r,i){const s=Fs();return new Promise((i,o)=>{const a=new h;a.setWithCredentials(!0),a.listenOnce(d.COMPLETE,()=>{try{switch(a.getLastErrorCode()){case p.NO_ERROR:const e=a.getResponseJson();x(zs,`XHR for RPC '${t}' ${s} received:`,JSON.stringify(e)),i(e);break;case p.TIMEOUT:x(zs,`RPC '${t}' ${s} timed out`),o(new L(P.DEADLINE_EXCEEDED,"Request time out"));break;case p.HTTP_ERROR:const n=a.getStatus();if(x(zs,`RPC '${t}' ${s} failed with status:`,n,"response text:",a.getResponseText()),n>0){let t=a.getResponseJson();Array.isArray(t)&&(t=t[0]);const e=null==t?void 0:t.error;if(e&&e.status&&e.message){const t=function(t){const e=t.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(e)>=0?e:P.UNKNOWN}(e.status);o(new L(t,e.message))}else o(new L(P.UNKNOWN,"Server responded with status "+a.getStatus()))}else o(new L(P.UNAVAILABLE,"Connection failed."));break;default:N(9055,{h_:t,streamId:s,P_:a.getLastErrorCode(),T_:a.getLastError()})}}finally{x(zs,`RPC '${t}' ${s} completed.`)}});const c=JSON.stringify(r);x(zs,`RPC '${t}' ${s} sending request:`,r),a.send(e,"POST",c,n,15)})}I_(t,e,n){const r=Fs(),i=[this.Ko,"/","google.firestore.v1.Firestore","/",t,"/channel"],s=v(),o=y(),a={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;void 0!==c&&(a.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(a.useFetchStreams=!0),this.Ho(a.initMessageHeaders,e,n),a.encodeInitMessageHeaders=!0;const u=i.join("");x(zs,`Creating RPC '${t}' stream ${r}: ${u}`,a);const l=s.createWebChannel(u,a);this.E_(l);let h=!1,d=!1;const p=new $s({Zo:e=>{d?x(zs,`Not sending because RPC '${t}' stream ${r} is closed:`,e):(h||(x(zs,`Opening RPC '${t}' stream ${r} transport.`),l.open(),h=!0),x(zs,`RPC '${t}' stream ${r} sending:`,e),l.send(e))},Xo:()=>l.close()}),w=(t,e,n)=>{t.listen(e,t=>{try{n(t)}catch(t){setTimeout(()=>{throw t},0)}})};return w(l,f.EventType.OPEN,()=>{d||(x(zs,`RPC '${t}' stream ${r} transport opened.`),p.__())}),w(l,f.EventType.CLOSE,()=>{d||(d=!0,x(zs,`RPC '${t}' stream ${r} transport closed`),p.u_(),this.d_(l))}),w(l,f.EventType.ERROR,e=>{d||(d=!0,D(zs,`RPC '${t}' stream ${r} transport errored. Name:`,e.name,"Message:",e.message),p.u_(new L(P.UNAVAILABLE,"The operation could not be completed")))}),w(l,f.EventType.MESSAGE,e=>{var n;if(!d){const i=e.data[0];R(!!i,16349);const s=i,o=(null==s?void 0:s.error)||(null===(n=s[0])||void 0===n?void 0:n.error);if(o){x(zs,`RPC '${t}' stream ${r} received error:`,o);const e=o.status;let n=function(t){const e=Lr[t];if(void 0!==e)return Ur(e)}(e),i=o.message;void 0===n&&(n=P.INTERNAL,i="Unknown error status: "+e+" with message "+o.message),d=!0,p.u_(new L(n,i)),l.close()}else x(zs,`RPC '${t}' stream ${r} received:`,i),p.c_(i)}}),w(o,m.STAT_EVENT,e=>{e.stat===g.PROXY?x(zs,`RPC '${t}' stream ${r} detected buffering proxy`):e.stat===g.NOPROXY&&x(zs,`RPC '${t}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{p.a_()},0),p}terminate(){this.l_.forEach(t=>t.close()),this.l_=[]}E_(t){this.l_.push(t)}d_(t){this.l_=this.l_.filter(e=>e===t)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hs(t){return new ii(t,!0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qs="PersistentStream";class Ws{constructor(t,e,n,r,i,s,o,a){this.xi=t,this.S_=n,this.D_=r,this.connection=i,this.authCredentialsProvider=s,this.appCheckCredentialsProvider=o,this.listener=a,this.state=0,this.v_=0,this.C_=null,this.F_=null,this.stream=null,this.M_=0,this.x_=new Gs(t,e)}O_(){return 1===this.state||5===this.state||this.N_()}N_(){return 2===this.state||3===this.state}start(){this.M_=0,4!==this.state?this.auth():this.B_()}async stop(){this.O_()&&await this.close(0)}L_(){this.state=0,this.x_.reset()}k_(){this.N_()&&null===this.C_&&(this.C_=this.xi.enqueueAfterDelay(this.S_,6e4,()=>this.q_()))}Q_(t){this.U_(),this.stream.send(t)}async q_(){if(this.N_())return this.close(0)}U_(){this.C_&&(this.C_.cancel(),this.C_=null)}K_(){this.F_&&(this.F_.cancel(),this.F_=null)}async close(t,e){this.U_(),this.K_(),this.x_.cancel(),this.v_++,4!==t?this.x_.reset():e&&e.code===P.RESOURCE_EXHAUSTED?(A(e.toString()),A("Using maximum backoff delay to prevent overloading the backend."),this.x_.p_()):e&&e.code===P.UNAUTHENTICATED&&3!==this.state&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),null!==this.stream&&(this.W_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.i_(e)}W_(){}auth(){this.state=1;const t=this.G_(this.v_),e=this.v_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([t,n])=>{this.v_===e&&this.z_(t,n)},e=>{t(()=>{const t=new L(P.UNKNOWN,"Fetching auth token failed: "+e.message);return this.j_(t)})})}z_(t,e){const n=this.G_(this.v_);this.stream=this.H_(t,e),this.stream.e_(()=>{n(()=>this.listener.e_())}),this.stream.n_(()=>{n(()=>(this.state=2,this.F_=this.xi.enqueueAfterDelay(this.D_,1e4,()=>(this.N_()&&(this.state=3),Promise.resolve())),this.listener.n_()))}),this.stream.i_(t=>{n(()=>this.j_(t))}),this.stream.onMessage(t=>{n(()=>1==++this.M_?this.J_(t):this.onNext(t))})}B_(){this.state=5,this.x_.y_(async()=>{this.state=0,this.start()})}j_(t){return x(Qs,`close with error: ${t}`),this.stream=null,this.close(4,t)}G_(t){return e=>{this.xi.enqueueAndForget(()=>this.v_===t?e():(x(Qs,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class Xs extends Ws{constructor(t,e,n,r,i,s){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,n,r,s),this.serializer=i}H_(t,e){return this.connection.I_("Listen",t,e)}J_(t){return this.onNext(t)}onNext(t){this.x_.reset();const e=bi(this.serializer,t),n=function(t){if(!("targetChange"in t))return rt.min();const e=t.targetChange;return e.targetIds&&e.targetIds.length?rt.min():e.readTime?ui(e.readTime):rt.min()}(t);return this.listener.Y_(e,n)}Z_(t){const e={};e.database=yi(this.serializer),e.addTarget=function(t,e){let n;const r=e.target;if(n=Tn(r)?{documents:Ti(t,r)}:{query:Si(t,r).gt},n.targetId=e.targetId,e.resumeToken.approximateByteSize()>0){n.resumeToken=ai(t,e.resumeToken);const r=si(t,e.expectedCount);null!==r&&(n.expectedCount=r)}else if(e.snapshotVersion.compareTo(rt.min())>0){n.readTime=oi(t,e.snapshotVersion.toTimestamp());const r=si(t,e.expectedCount);null!==r&&(n.expectedCount=r)}return n}(this.serializer,t);const n=Ii(this.serializer,t);n&&(e.labels=n),this.Q_(e)}X_(t){const e={};e.database=yi(this.serializer),e.removeTarget=t,this.Q_(e)}}class Ys extends Ws{constructor(t,e,n,r,i,s){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,n,r,s),this.serializer=i}get ea(){return this.M_>0}start(){this.lastStreamToken=void 0,super.start()}W_(){this.ea&&this.ta([])}H_(t,e){return this.connection.I_("Write",t,e)}J_(t){return R(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,R(!t.writeResults||0===t.writeResults.length,55816),this.listener.na()}onNext(t){R(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.x_.reset();const e=Ei(t.writeResults,t.commitTime),n=ui(t.commitTime);return this.listener.ra(n,e)}ia(){const t={};t.database=yi(this.serializer),this.Q_(t)}ta(t){const e={streamToken:this.lastStreamToken,writes:t.map(t=>_i(this.serializer,t))};this.Q_(e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eo="RemoteStore";class no{constructor(t,e,n,r,i){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.Ia=[],this.Ea=new Map,this.da=new Set,this.Aa=[],this.Ra=i,this.Ra.No(t=>{n.enqueueAndForget(async()=>{ho(this)&&(x(eo,"Restarting streams for network reachability change."),await async function(t){const e=M(t);e.da.add(4),await io(e),e.Va.set("Unknown"),e.da.delete(4),await ro(e)}(this))})}),this.Va=new to(n,r)}}async function ro(t){if(ho(t))for(const e of t.Aa)await e(!0)}async function io(t){for(const e of t.Aa)await e(!1)}function so(t,e){const n=M(t);n.Ea.has(e.targetId)||(n.Ea.set(e.targetId,e),lo(n)?uo(n):No(n).N_()&&ao(n,e))}function oo(t,e){const n=M(t),r=No(n);n.Ea.delete(e),r.N_()&&co(n,e),0===n.Ea.size&&(r.N_()?r.k_():ho(n)&&n.Va.set("Unknown"))}function ao(t,e){if(t.ma.Ke(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(rt.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}No(t).Z_(e)}function co(t,e){t.ma.Ke(e),No(t).X_(e)}function uo(t){t.ma=new Zr({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),Rt:e=>t.Ea.get(e)||null,Pt:()=>t.datastore.serializer.databaseId}),No(t).start(),t.Va.ca()}function lo(t){return ho(t)&&!No(t).O_()&&t.Ea.size>0}function ho(t){return 0===M(t).da.size}function fo(t){t.ma=void 0}async function po(t){t.Va.set("Online")}async function go(t){t.Ea.forEach((e,n)=>{ao(t,e)})}async function mo(t,e){fo(t),lo(t)?(t.Va.Pa(e),uo(t)):t.Va.set("Unknown")}async function yo(t,e,n){if(t.Va.set("Online"),e instanceof Xr&&2===e.state&&e.cause)try{await async function(t,e){const n=e.cause;for(const r of e.targetIds)t.Ea.has(r)&&(await t.remoteSyncer.rejectListen(r,n),t.Ea.delete(r),t.ma.removeTarget(r))}(t,e)}catch(n){x(eo,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await vo(t,n)}else if(e instanceof Qr?t.ma.Xe(e):e instanceof Wr?t.ma.ot(e):t.ma.nt(e),!n.isEqual(rt.min()))try{const e=await Ss(t.localStore);n.compareTo(e)>=0&&await function(t,e){const n=t.ma.It(e);return n.targetChanges.forEach((n,r)=>{if(n.resumeToken.approximateByteSize()>0){const i=t.Ea.get(r);i&&t.Ea.set(r,i.withResumeToken(n.resumeToken,e))}}),n.targetMismatches.forEach((e,n)=>{const r=t.Ea.get(e);if(!r)return;t.Ea.set(e,r.withResumeToken(le.EMPTY_BYTE_STRING,r.snapshotVersion)),co(t,e);const i=new Li(r.target,e,n,r.sequenceNumber);ao(t,i)}),t.remoteSyncer.applyRemoteEvent(n)}(t,n)}catch(e){x(eo,"Failed to raise snapshot:",e),await vo(t,e)}}async function vo(t,e,n){if(!_t(e))throw e;t.da.add(1),await io(t),t.Va.set("Offline"),n||(n=()=>Ss(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{x(eo,"Retrying IndexedDB access"),await n(),t.da.delete(1),await ro(t)})}function wo(t,e){return e().catch(n=>vo(t,n,e))}async function bo(t){const e=M(t),n=Oo(e);let r=e.Ia.length>0?e.Ia[e.Ia.length-1].batchId:Tt;for(;_o(e);)try{const t=await xs(e.localStore,r);if(null===t){0===e.Ia.length&&n.k_();break}r=t.batchId,Eo(e,t)}catch(t){await vo(e,t)}To(e)&&So(e)}function _o(t){return ho(t)&&t.Ia.length<10}function Eo(t,e){t.Ia.push(e);const n=Oo(t);n.N_()&&n.ea&&n.ta(e.mutations)}function To(t){return ho(t)&&!Oo(t).O_()&&t.Ia.length>0}function So(t){Oo(t).start()}async function Co(t){Oo(t).ia()}async function Io(t){const e=Oo(t);for(const n of t.Ia)e.ta(n.mutations)}async function xo(t,e,n){const r=t.Ia.shift(),i=Rr.from(r,e,n);await wo(t,()=>t.remoteSyncer.applySuccessfulWrite(i)),await bo(t)}async function Ao(t,e){e&&Oo(t).ea&&await async function(t,e){if(function(t){return Fr(t)&&t!==P.ABORTED}(e.code)){const n=t.Ia.shift();Oo(t).L_(),await wo(t,()=>t.remoteSyncer.rejectFailedWrite(n.batchId,e)),await bo(t)}}(t,e),To(t)&&So(t)}async function Do(t,e){const n=M(t);n.asyncQueue.verifyOperationInProgress(),x(eo,"RemoteStore received new credentials");const r=ho(n);n.da.add(3),await io(n),r&&n.Va.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.da.delete(3),await ro(n)}async function ko(t,e){const n=M(t);e?(n.da.delete(2),await ro(n)):e||(n.da.add(2),await io(n),n.Va.set("Unknown"))}function No(t){return t.fa||(t.fa=function(t,e,n){const r=M(t);return r.oa(),new Xs(e,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}(t.datastore,t.asyncQueue,{e_:po.bind(null,t),n_:go.bind(null,t),i_:mo.bind(null,t),Y_:yo.bind(null,t)}),t.Aa.push(async e=>{e?(t.fa.L_(),lo(t)?uo(t):t.Va.set("Unknown")):(await t.fa.stop(),fo(t))})),t.fa}function Oo(t){return t.ga||(t.ga=function(t,e,n){const r=M(t);return r.oa(),new Ys(e,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)}(t.datastore,t.asyncQueue,{e_:()=>Promise.resolve(),n_:Co.bind(null,t),i_:Ao.bind(null,t),na:Io.bind(null,t),ra:xo.bind(null,t)}),t.Aa.push(async e=>{e?(t.ga.L_(),await bo(t)):(await t.ga.stop(),t.Ia.length>0&&(x(eo,`Stopping write stream with ${t.Ia.length} pending writes`),t.Ia=[]))})),t.ga
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fo{constructor(){this.ba=void 0,this.Sa=[]}Da(){return this.Sa.some(t=>t.va())}}class Uo{constructor(){this.queries=jo(),this.onlineState="Unknown",this.Ca=new Set}terminate(){!function(t,e){const n=M(t),r=n.queries;n.queries=jo(),r.forEach((t,n)=>{for(const r of n.Sa)r.onError(e)})}(this,new L(P.ABORTED,"Firestore shutting down"))}}function jo(){return new jn(t=>Mn(t),Rn)}async function Bo(t,e){const n=M(t);let r=3;const i=e.query;let s=n.queries.get(i);s?!s.Da()&&e.va()&&(r=2):(s=new Fo,r=e.va()?0:1);try{switch(r){case 0:s.ba=await n.onListen(i,!0);break;case 1:s.ba=await n.onListen(i,!1);break;case 2:await n.onFirstRemoteStoreListen(i)}}catch(t){const n=Mo(t,`Initialization of query '${Pn(e.query)}' failed`);return void e.onError(n)}n.queries.set(i,s),s.Sa.push(e),e.Fa(n.onlineState),s.ba&&e.Ma(s.ba)&&Ko(n)}async function $o(t,e){const n=M(t),r=e.query;let i=3;const s=n.queries.get(r);if(s){const t=s.Sa.indexOf(e);t>=0&&(s.Sa.splice(t,1),0===s.Sa.length?i=e.va()?0:1:!s.Da()&&e.va()&&(i=2))}switch(i){case 0:return n.queries.delete(r),n.onUnlisten(r,!0);case 1:return n.queries.delete(r),n.onUnlisten(r,!1);case 2:return n.onLastRemoteStoreUnlisten(r);default:return}}function zo(t,e){const n=M(t);let r=!1;for(const i of e){const t=i.query,e=n.queries.get(t);if(e){for(const t of e.Sa)t.Ma(i)&&(r=!0);e.ba=i}}r&&Ko(n)}function qo(t,e,n){const r=M(t),i=r.queries.get(e);if(i)for(const s of i.Sa)s.onError(n);r.queries.delete(e)}function Ko(t){t.Ca.forEach(t=>{t.next()})}var Ho,Go;(Go=Ho||(Ho={})).xa="default",Go.Cache="cache";class Qo{constructor(t,e,n){this.query=t,this.Oa=e,this.Na=!1,this.Ba=null,this.onlineState="Unknown",this.options=n||{}}Ma(t){if(!this.options.includeMetadataChanges){const e=[];for(const n of t.docChanges)3!==n.type&&e.push(n);t=new Vo(t.query,t.docs,t.oldDocs,e,t.mutatedKeys,t.fromCache,t.syncStateChanged,!0,t.hasCachedResults)}let e=!1;return this.Na?this.La(t)&&(this.Oa.next(t),e=!0):this.ka(t,this.onlineState)&&(this.qa(t),e=!0),this.Ba=t,e}onError(t){this.Oa.error(t)}Fa(t){this.onlineState=t;let e=!1;return this.Ba&&!this.Na&&this.ka(this.Ba,t)&&(this.qa(this.Ba),e=!0),e}ka(t,e){if(!t.fromCache)return!0;if(!this.va())return!0;const n="Offline"!==e;return(!this.options.Qa||!n)&&(!t.docs.isEmpty()||t.hasCachedResults||"Offline"===e)}La(t){if(t.docChanges.length>0)return!0;const e=this.Ba&&this.Ba.hasPendingWrites!==t.hasPendingWrites;return!(!t.syncStateChanged&&!e)&&!0===this.options.includeMetadataChanges}qa(t){t=Vo.fromInitialDocuments(t.query,t.docs,t.mutatedKeys,t.fromCache,t.hasCachedResults),this.Na=!0,this.Oa.next(t)}va(){return this.options.source!==Ho.Cache}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Wo{constructor(t){this.key=t}}class Xo{constructor(t){this.key=t}}class Yo{constructor(t,e){this.query=t,this.Ha=e,this.Ja=null,this.hasCachedResults=!1,this.current=!1,this.Ya=Yn(),this.mutatedKeys=Yn(),this.Za=Fn(t),this.Xa=new Po(this.Za)}get eu(){return this.Ha}tu(t,e){const n=e?e.nu:new Lo,r=e?e.Xa:this.Xa;let i=e?e.mutatedKeys:this.mutatedKeys,s=r,o=!1;const a="F"===this.query.limitType&&r.size===this.query.limit?r.last():null,c="L"===this.query.limitType&&r.size===this.query.limit?r.first():null;if(t.inorderTraversal((t,e)=>{const u=r.get(t),l=Ln(this.query,e)?e:null,h=!!u&&this.mutatedKeys.has(u.key),f=!!l&&(l.hasLocalMutations||this.mutatedKeys.has(l.key)&&l.hasCommittedMutations);let d=!1;u&&l?u.data.isEqual(l.data)?h!==f&&(n.track({type:3,doc:l}),d=!0):this.ru(u,l)||(n.track({type:2,doc:l}),d=!0,(a&&this.Za(l,a)>0||c&&this.Za(l,c)<0)&&(o=!0)):!u&&l?(n.track({type:0,doc:l}),d=!0):u&&!l&&(n.track({type:1,doc:u}),d=!0,(a||c)&&(o=!0)),d&&(l?(s=s.add(l),i=f?i.add(t):i.delete(t)):(s=s.delete(t),i=i.delete(t)))}),null!==this.query.limit)for(;s.size>this.query.limit;){const t="F"===this.query.limitType?s.last():s.first();s=s.delete(t.key),i=i.delete(t.key),n.track({type:1,doc:t})}return{Xa:s,nu:n,Cs:o,mutatedKeys:i}}ru(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,n,r){const i=this.Xa;this.Xa=t.Xa,this.mutatedKeys=t.mutatedKeys;const s=t.nu.wa();s.sort((t,e)=>function(t,e){const n=t=>{switch(t){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return N(20277,{Vt:t})}};return n(t)-n(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t.type,e.type)||this.Za(t.doc,e.doc)),this.iu(n),r=null!=r&&r;const o=e&&!r?this.su():[],a=0===this.Ya.size&&this.current&&!r?1:0,c=a!==this.Ja;return this.Ja=a,0!==s.length||c?{snapshot:new Vo(this.query,t.Xa,i,s,t.mutatedKeys,0===a,c,!1,!!n&&n.resumeToken.approximateByteSize()>0),ou:o}:{ou:o}}Fa(t){return this.current&&"Offline"===t?(this.current=!1,this.applyChanges({Xa:this.Xa,nu:new Lo,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{ou:[]}}_u(t){return!this.Ha.has(t)&&!!this.Xa.has(t)&&!this.Xa.get(t).hasLocalMutations}iu(t){t&&(t.addedDocuments.forEach(t=>this.Ha=this.Ha.add(t)),t.modifiedDocuments.forEach(t=>{}),t.removedDocuments.forEach(t=>this.Ha=this.Ha.delete(t)),this.current=t.current)}su(){if(!this.current)return[];const t=this.Ya;this.Ya=Yn(),this.Xa.forEach(t=>{this._u(t.key)&&(this.Ya=this.Ya.add(t.key))});const e=[];return t.forEach(t=>{this.Ya.has(t)||e.push(new Xo(t))}),this.Ya.forEach(n=>{t.has(n)||e.push(new Wo(n))}),e}au(t){this.Ha=t.$s,this.Ya=Yn();const e=this.tu(t.documents);return this.applyChanges(e,!0)}uu(){return Vo.fromInitialDocuments(this.query,this.Xa,this.mutatedKeys,0===this.Ja,this.hasCachedResults)}}const Zo="SyncEngine";class Jo{constructor(t,e,n){this.query=t,this.targetId=e,this.view=n}}class ta{constructor(t){this.key=t,this.cu=!1}}class ea{constructor(t,e,n,r,i,s){this.localStore=t,this.remoteStore=e,this.eventManager=n,this.sharedClientState=r,this.currentUser=i,this.maxConcurrentLimboResolutions=s,this.lu={},this.hu=new jn(t=>Mn(t),Rn),this.Pu=new Map,this.Tu=new Set,this.Iu=new re(ut.comparator),this.Eu=new Map,this.du=new ss,this.Au={},this.Ru=new Map,this.Vu=Ki.lr(),this.onlineState="Unknown",this.mu=void 0}get isPrimaryClient(){return!0===this.mu}}async function na(t,e,n=!0){const r=Sa(t);let i;const s=r.hu.get(e);return s?(r.sharedClientState.addLocalQueryTarget(s.targetId),i=s.view.uu()):i=await ia(r,e,n,!0),i}async function ra(t,e){const n=Sa(t);await ia(n,e,!0,!1)}async function ia(t,e,n,r){const i=await As(t.localStore,kn(e)),s=i.targetId,o=t.sharedClientState.addLocalQueryTarget(s,n);let a;return r&&(a=await sa(t,e,s,"current"===o,i.resumeToken)),t.isPrimaryClient&&n&&so(t.remoteStore,i),a}async function sa(t,e,n,r,i){t.fu=(e,n,r)=>async function(t,e,n,r){let i=e.view.tu(n);i.Cs&&(i=await ks(t.localStore,e.query,!1).then(({documents:t})=>e.view.tu(t,i)));const s=r&&r.targetChanges.get(e.targetId),o=r&&null!=r.targetMismatches.get(e.targetId),a=e.view.applyChanges(i,t.isPrimaryClient,s,o);return va(t,e.targetId,a.ou),a.snapshot}(t,e,n,r);const s=await ks(t.localStore,e,!0),o=new Yo(e,s.$s),a=o.tu(s.documents),c=Gr.createSynthesizedTargetChangeForCurrentChange(n,r&&"Offline"!==t.onlineState,i),u=o.applyChanges(a,t.isPrimaryClient,c);va(t,n,u.ou);const l=new Jo(e,n,o);return t.hu.set(e,l),t.Pu.has(n)?t.Pu.get(n).push(e):t.Pu.set(n,[e]),u.snapshot}async function oa(t,e,n){const r=M(t),i=r.hu.get(e),s=r.Pu.get(i.targetId);if(s.length>1)return r.Pu.set(i.targetId,s.filter(t=>!Rn(t,e))),void r.hu.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(i.targetId),r.sharedClientState.isActiveQueryTarget(i.targetId)||await Ds(r.localStore,i.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(i.targetId),n&&oo(r.remoteStore,i.targetId),ma(r,i.targetId)}).catch(vt)):(ma(r,i.targetId),await Ds(r.localStore,i.targetId,!0))}async function aa(t,e){const n=M(t),r=n.hu.get(e),i=n.Pu.get(r.targetId);n.isPrimaryClient&&1===i.length&&(n.sharedClientState.removeLocalQueryTarget(r.targetId),oo(n.remoteStore,r.targetId))}async function ca(t,e,n){const r=Ca(t);try{const t=await function(t,e){const n=M(t),r=nt.now(),i=e.reduce((t,e)=>t.add(e.key),Yn());let s,o;return n.persistence.runTransaction("Locally write mutations","readwrite",t=>{let a=$n(),c=Yn();return n.Bs.getEntries(t,i).next(t=>{a=t,a.forEach((t,e)=>{e.isValidDocument()||(c=c.add(t))})}).next(()=>n.localDocuments.getOverlayedDocuments(t,a)).next(i=>{s=i;const o=[];for(const t of e){const e=Tr(t,s.get(t.key).overlayedDocument);null!=e&&o.push(new Ir(t.key,e,Qe(e.value.mapValue),yr.exists(!0)))}return n.mutationQueue.addMutationBatch(t,r,o,e)}).next(e=>{o=e;const r=e.applyToLocalDocumentSet(s,c);return n.documentOverlayCache.saveOverlays(t,e.batchId,r)})}).then(()=>({batchId:o.batchId,changes:Kn(s)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(t.batchId),function(t,e,n){let r=t.Au[t.currentUser.toKey()];r||(r=new re(W)),r=r.insert(e,n),t.Au[t.currentUser.toKey()]=r}(r,t.batchId,n),await _a(r,t.changes),await bo(r.remoteStore)}catch(t){const e=Mo(t,"Failed to persist write");n.reject(e)}}async function ua(t,e){const n=M(t);try{const t=await Cs(n.localStore,e);e.targetChanges.forEach((t,e)=>{const r=n.Eu.get(e);r&&(R(t.addedDocuments.size+t.modifiedDocuments.size+t.removedDocuments.size<=1,22616),t.addedDocuments.size>0?r.cu=!0:t.modifiedDocuments.size>0?R(r.cu,14607):t.removedDocuments.size>0&&(R(r.cu,42227),r.cu=!1))}),await _a(n,t,e)}catch(t){await vt(t)}}function la(t,e,n){const r=M(t);if(r.isPrimaryClient&&0===n||!r.isPrimaryClient&&1===n){const t=[];r.hu.forEach((n,r)=>{const i=r.view.Fa(e);i.snapshot&&t.push(i.snapshot)}),function(t,e){const n=M(t);n.onlineState=e;let r=!1;n.queries.forEach((t,n)=>{for(const i of n.Sa)i.Fa(e)&&(r=!0)}),r&&Ko(n)}(r.eventManager,e),t.length&&r.lu.Y_(t),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function ha(t,e,n){const r=M(t);r.sharedClientState.updateQueryState(e,"rejected",n);const i=r.Eu.get(e),s=i&&i.key;if(s){let t=new re(ut.comparator);t=t.insert(s,We.newNoDocument(s,rt.min()));const n=Yn().add(s),i=new Hr(rt.min(),new Map,new re(W),t,n);await ua(r,i),r.Iu=r.Iu.remove(s),r.Eu.delete(e),ba(r)}else await Ds(r.localStore,e,!1).then(()=>ma(r,e,n)).catch(vt)}async function fa(t,e){const n=M(t),r=e.batch.batchId;try{const t=await Ts(n.localStore,e);ga(n,r,null),pa(n,r),n.sharedClientState.updateMutationState(r,"acknowledged"),await _a(n,t)}catch(t){await vt(t)}}async function da(t,e,n){const r=M(t);try{const t=await function(t,e){const n=M(t);return n.persistence.runTransaction("Reject batch","readwrite-primary",t=>{let r;return n.mutationQueue.lookupMutationBatch(t,e).next(e=>(R(null!==e,37113),r=e.keys(),n.mutationQueue.removeMutationBatch(t,e))).next(()=>n.mutationQueue.performConsistencyCheck(t)).next(()=>n.documentOverlayCache.removeOverlaysForBatchId(t,r,e)).next(()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(t,r)).next(()=>n.localDocuments.getDocuments(t,r))})}(r.localStore,e);ga(r,e,n),pa(r,e),r.sharedClientState.updateMutationState(e,"rejected",n),await _a(r,t)}catch(n){await vt(n)}}function pa(t,e){(t.Ru.get(e)||[]).forEach(t=>{t.resolve()}),t.Ru.delete(e)}function ga(t,e,n){const r=M(t);let i=r.Au[r.currentUser.toKey()];if(i){const t=i.get(e);t&&(n?t.reject(n):t.resolve(),i=i.remove(e)),r.Au[r.currentUser.toKey()]=i}}function ma(t,e,n=null){t.sharedClientState.removeLocalQueryTarget(e);for(const r of t.Pu.get(e))t.hu.delete(r),n&&t.lu.gu(r,n);t.Pu.delete(e),t.isPrimaryClient&&t.du.Hr(e).forEach(e=>{t.du.containsKey(e)||ya(t,e)})}function ya(t,e){t.Tu.delete(e.path.canonicalString());const n=t.Iu.get(e);null!==n&&(oo(t.remoteStore,n),t.Iu=t.Iu.remove(e),t.Eu.delete(n),ba(t))}function va(t,e,n){for(const r of n)r instanceof Wo?(t.du.addReference(r.key,e),wa(t,r)):r instanceof Xo?(x(Zo,"Document no longer in limbo: "+r.key),t.du.removeReference(r.key,e),t.du.containsKey(r.key)||ya(t,r.key)):N(19791,{pu:r})}function wa(t,e){const n=e.key,r=n.path.canonicalString();t.Iu.get(n)||t.Tu.has(r)||(x(Zo,"New document in limbo: "+n),t.Tu.add(r),ba(t))}function ba(t){for(;t.Tu.size>0&&t.Iu.size<t.maxConcurrentLimboResolutions;){const e=t.Tu.values().next().value;t.Tu.delete(e);const n=new ut(ot.fromString(e)),r=t.Vu.next();t.Eu.set(r,new ta(n)),t.Iu=t.Iu.insert(n,r),so(t.remoteStore,new Li(kn(In(n.path)),r,"TargetPurposeLimboResolution",Et.le))}}async function _a(t,e,n){const r=M(t),i=[],s=[],o=[];r.hu.isEmpty()||(r.hu.forEach((t,a)=>{o.push(r.fu(a,e,n).then(t=>{var e;if((t||n)&&r.isPrimaryClient){const i=t?!t.fromCache:null===(e=null==n?void 0:n.targetChanges.get(a.targetId))||void 0===e?void 0:e.current;r.sharedClientState.updateQueryState(a.targetId,i?"current":"not-current")}if(t){i.push(t);const e=gs.Rs(a.targetId,t);s.push(e)}}))}),await Promise.all(o),r.lu.Y_(i),await async function(t,e){const n=M(t);try{await n.persistence.runTransaction("notifyLocalViewChanges","readwrite",t=>wt.forEach(e,e=>wt.forEach(e.ds,r=>n.persistence.referenceDelegate.addReference(t,e.targetId,r)).next(()=>wt.forEach(e.As,r=>n.persistence.referenceDelegate.removeReference(t,e.targetId,r)))))}catch(t){if(!_t(t))throw t;x(vs,"Failed to update sequence numbers: "+t)}for(const r of e){const t=r.targetId;if(!r.fromCache){const e=n.xs.get(t),r=e.snapshotVersion,i=e.withLastLimboFreeSnapshotVersion(r);n.xs=n.xs.insert(t,i)}}}(r.localStore,s))}async function Ea(t,e){const n=M(t);if(!n.currentUser.isEqual(e)){x(Zo,"User change. New user:",e.toKey());const t=await Es(n.localStore,e);n.currentUser=e,function(t,e){t.Ru.forEach(t=>{t.forEach(t=>{t.reject(new L(P.CANCELLED,e))})}),t.Ru.clear()}(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(e,t.removedBatchIds,t.addedBatchIds),await _a(n,t.ks)}}function Ta(t,e){const n=M(t),r=n.Eu.get(e);if(r&&r.cu)return Yn().add(r.key);{let t=Yn();const r=n.Pu.get(e);if(!r)return t;for(const e of r){const r=n.hu.get(e);t=t.unionWith(r.view.eu)}return t}}function Sa(t){const e=M(t);return e.remoteStore.remoteSyncer.applyRemoteEvent=ua.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=Ta.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=ha.bind(null,e),e.lu.Y_=zo.bind(null,e.eventManager),e.lu.gu=qo.bind(null,e.eventManager),e}function Ca(t){const e=M(t);return e.remoteStore.remoteSyncer.applySuccessfulWrite=fa.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=da.bind(null,e),e}class Ia{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=Hs(t.databaseInfo.databaseId),this.sharedClientState=this.bu(t),this.persistence=this.Su(t),await this.persistence.start(),this.localStore=this.Du(t),this.gcScheduler=this.vu(t,this.localStore),this.indexBackfillerScheduler=this.Cu(t,this.localStore)}vu(t,e){return null}Cu(t,e){return null}Du(t){return _s(this.persistence,new ys,t.initialUser,this.serializer)}Su(t){return new hs(ds.fi,this.serializer)}bu(t){return new Rs}async terminate(){var t,e;null===(t=this.gcScheduler)||void 0===t||t.stop(),null===(e=this.indexBackfillerScheduler)||void 0===e||e.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Ia.provider={build:()=>new Ia};class xa extends Ia{constructor(t){super(),this.cacheSizeBytes=t}vu(t,e){R(this.persistence.referenceDelegate instanceof ps,46915);const n=this.persistence.referenceDelegate.garbageCollector;return new Xi(n,t.asyncQueue,e)}Su(t){const e=void 0!==this.cacheSizeBytes?qi.withCacheSize(this.cacheSizeBytes):qi.DEFAULT;return new hs(t=>ps.fi(t,e),this.serializer)}}class Aa{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=t=>la(this.syncEngine,t,1),this.remoteStore.remoteSyncer.handleCredentialChange=Ea.bind(null,this.syncEngine),await ko(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return function(){return new Uo}()}createDatastore(t){const e=Hs(t.databaseInfo.databaseId),n=function(t){return new qs(t)}(t.databaseInfo);return function(t,e,n,r){return new Js(t,e,n,r)}(t.authCredentials,t.appCheckCredentials,n,e)}createRemoteStore(t){return function(t,e,n,r,i){return new no(t,e,n,r,i)}(this.localStore,this.datastore,t.asyncQueue,t=>la(this.syncEngine,t,0),function(){return Ls.C()?new Ls:new Ms}())}createSyncEngine(t,e){return function(t,e,n,r,i,s,o){const a=new ea(t,e,n,r,i,s);return o&&(a.mu=!0),a}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}async terminate(){var t,e;await async function(t){const e=M(t);x(eo,"RemoteStore shutting down."),e.da.add(5),await io(e),e.Ra.shutdown(),e.Va.set("Unknown")}(this.remoteStore),null===(t=this.datastore)||void 0===t||t.terminate(),null===(e=this.eventManager)||void 0===e||e.terminate()}}Aa.provider={build:()=>new Aa};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Da{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.Mu(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.Mu(this.observer.error,t):A("Uncaught Error in snapshot listener:",t.toString()))}xu(){this.muted=!0}Mu(t,e){setTimeout(()=>{this.muted||t(e)},0)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ba(t,e,n){if(!n)throw new L(P.INVALID_ARGUMENT,`Function ${t}() cannot be called with an empty ${e}.`)}function $a(t,e,n,r){if(!0===e&&!0===r)throw new L(P.INVALID_ARGUMENT,`${t} and ${n} cannot be used together.`)}function za(t){if(!ut.isDocumentKey(t))throw new L(P.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`)}function qa(t){if(ut.isDocumentKey(t))throw new L(P.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`)}function Ka(t){if(void 0===t)return"undefined";if(null===t)return"null";if("string"==typeof t)return t.length>20&&(t=`${t.substring(0,20)}...`),JSON.stringify(t);if("number"==typeof t||"boolean"==typeof t)return""+t;if("object"==typeof t){if(t instanceof Array)return"an array";{const e=function(t){return t.constructor?t.constructor.name:null}(t);return e?`a custom ${e} object`:"an object"}}return"function"==typeof t?"a function":N(12329,{type:typeof t})}function Ha(t,e){if("_delegate"in t&&(t=t._delegate),!(t instanceof e)){if(e.name===t.constructor.name)throw new L(P.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const n=Ka(t);throw new L(P.INVALID_ARGUMENT,`Expected type '${e.name}', but it was: ${n}`)}}return t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ga="firestore.googleapis.com",Qa=!0;class Wa{constructor(t){var e,n;if(void 0===t.host){if(void 0!==t.ssl)throw new L(P.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=Ga,this.ssl=Qa}else this.host=t.host,this.ssl=null!==(e=t.ssl)&&void 0!==e?e:Qa;if(this.isUsingEmulator=void 0!==t.emulatorOptions,this.credentials=t.credentials,this.ignoreUndefinedProperties=!!t.ignoreUndefinedProperties,this.localCache=t.localCache,void 0===t.cacheSizeBytes)this.cacheSizeBytes=zi;else{if(-1!==t.cacheSizeBytes&&t.cacheSizeBytes<Gi)throw new L(P.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=t.cacheSizeBytes}$a("experimentalForceLongPolling",t.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",t.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!t.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:void 0===t.experimentalAutoDetectLongPolling?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!t.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=Ua(null!==(n=t.experimentalLongPollingOptions)&&void 0!==n?n:{}),function(t){if(void 0!==t.timeoutSeconds){if(isNaN(t.timeoutSeconds))throw new L(P.INVALID_ARGUMENT,`invalid long polling timeout: ${t.timeoutSeconds} (must not be NaN)`);if(t.timeoutSeconds<5)throw new L(P.INVALID_ARGUMENT,`invalid long polling timeout: ${t.timeoutSeconds} (minimum allowed value is 5)`);if(t.timeoutSeconds>30)throw new L(P.INVALID_ARGUMENT,`invalid long polling timeout: ${t.timeoutSeconds} (maximum allowed value is 30)`)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Za{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new Za(this.firestore,t,this._query)}}class Ja{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new tc(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new Ja(this.firestore,t,this._key)}}class tc extends Za{constructor(t,e,n){super(t,e,In(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new Ja(this.firestore,null,new ut(t))}withConverter(t){return new tc(this.firestore,t,this._path)}}function ec(t,e,...n){if(t=(0,c.Ku)(t),Ba("collection","path",e),t instanceof Xa){const r=ot.fromString(e,...n);return qa(r),new tc(t,null,r)}{if(!(t instanceof Ja||t instanceof tc))throw new L(P.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(ot.fromString(e,...n));return qa(r),new tc(t.firestore,null,r)}}function nc(t,e,...n){if(t=(0,c.Ku)(t),1===arguments.length&&(e=Q.newId()),Ba("doc","path",e),t instanceof Xa){const r=ot.fromString(e,...n);return za(r),new Ja(t,null,new ut(r))}{if(!(t instanceof Ja||t instanceof tc))throw new L(P.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(ot.fromString(e,...n));return za(r),new Ja(t.firestore,t instanceof tc?t.converter:null,new ut(r))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const rc="AsyncQueue";class ic{constructor(t=Promise.resolve()){this.Ju=[],this.Yu=!1,this.Zu=[],this.Xu=null,this.ec=!1,this.tc=!1,this.nc=[],this.x_=new Gs(this,"async_queue_retry"),this.rc=()=>{const t=Ks();t&&x(rc,"Visibility state changed to "+t.visibilityState),this.x_.b_()},this.sc=t;const e=Ks();e&&"function"==typeof e.addEventListener&&e.addEventListener("visibilitychange",this.rc)}get isShuttingDown(){return this.Yu}enqueueAndForget(t){this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this.oc(),this._c(t)}enterRestrictedMode(t){if(!this.Yu){this.Yu=!0,this.tc=t||!1;const e=Ks();e&&"function"==typeof e.removeEventListener&&e.removeEventListener("visibilitychange",this.rc)}}enqueue(t){if(this.oc(),this.Yu)return new Promise(()=>{});const e=new V;return this._c(()=>this.Yu&&this.tc?Promise.resolve():(t().then(e.resolve,e.reject),e.promise)).then(()=>e.promise)}enqueueRetryable(t){this.enqueueAndForget(()=>(this.Ju.push(t),this.ac()))}async ac(){if(0!==this.Ju.length){try{await this.Ju[0](),this.Ju.shift(),this.x_.reset()}catch(t){if(!_t(t))throw t;x(rc,"Operation failed with retryable error: "+t)}this.Ju.length>0&&this.x_.y_(()=>this.ac())}}_c(t){const e=this.sc.then(()=>(this.ec=!0,t().catch(t=>{throw this.Xu=t,this.ec=!1,A("INTERNAL UNHANDLED ERROR: ",sc(t)),t}).then(t=>(this.ec=!1,t))));return this.sc=e,e}enqueueAfterDelay(t,e,n){this.oc(),this.nc.indexOf(t)>-1&&(e=0);const r=Ro.createAndSchedule(this,t,e,n,t=>this.uc(t));return this.Zu.push(r),r}oc(){this.Xu&&N(47125,{cc:sc(this.Xu)})}verifyOperationInProgress(){}async lc(){let t;do{t=this.sc,await t}while(t!==this.sc)}hc(t){for(const e of this.Zu)if(e.timerId===t)return!0;return!1}Pc(t){return this.lc().then(()=>{this.Zu.sort((t,e)=>t.targetTimeMs-e.targetTimeMs);for(const e of this.Zu)if(e.skipDelay(),"all"!==t&&e.timerId===t)break;return this.lc()})}Tc(t){this.nc.push(t)}uc(t){const e=this.Zu.indexOf(t);this.Zu.splice(e,1)}}function sc(t){let e=t.message||"";return t.stack&&(e=t.stack.includes(t.message)?t.stack:t.message+"\n"+t.stack),e
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}class oc extends Xa{constructor(t,e,n,r){super(t,e,n,r),this.type="firestore",this._queue=new ic,this._persistenceKey=(null==r?void 0:r.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new ic(t),this._firestoreClient=void 0,await t}}}function ac(t,e){const n="object"==typeof t?t:(0,s.Sx)(),r="string"==typeof t?t:e||Te,i=(0,s.j6)(n,"firestore").getImmediate({identifier:r});if(!i._initialized){const t=(0,c.yU)("firestore");t&&Ya(i,...t)}return i}function cc(t){if(t._terminated)throw new L(P.FAILED_PRECONDITION,"The client has already been terminated.");return t._firestoreClient||uc(t),t._firestoreClient}function uc(t){var e,n,r;const i=t._freezeSettings(),s=function(t,e,n,r){return new Ee(t,e,n,r.host,r.ssl,r.experimentalForceLongPolling,r.experimentalAutoDetectLongPolling,Ua(r.experimentalLongPollingOptions),r.useFetchStreams,r.isUsingEmulator)}(t._databaseId,(null===(e=t._app)||void 0===e?void 0:e.options.appId)||"",t._persistenceKey,i);t._componentsProvider||(null===(n=i.localCache)||void 0===n?void 0:n._offlineComponentProvider)&&(null===(r=i.localCache)||void 0===r?void 0:r._onlineComponentProvider)&&(t._componentsProvider={_offline:i.localCache._offlineComponentProvider,_online:i.localCache._onlineComponentProvider}),t._firestoreClient=new Na(t._authCredentials,t._appCheckCredentials,t._queue,s,t._componentsProvider&&function(t){const e=null==t?void 0:t._online.build();return{_offline:null==t?void 0:t._offline.build(e),_online:e}}(t._componentsProvider))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class lc{constructor(t){this._byteString=t}static fromBase64String(t){try{return new lc(le.fromBase64String(t))}catch(t){throw new L(P.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(t){return new lc(le.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hc{constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new L(P.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ct(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dc{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new L(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new L(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return W(this._lat,t._lat)||W(this._long,t._long)}}
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pc{constructor(t){this._values=(t||[]).map(t=>t)}toArray(){return this._values.map(t=>t)}isEqual(t){return function(t,e){if(t.length!==e.length)return!1;for(let n=0;n<t.length;++n)if(t[n]!==e[n])return!1;return!0}(this._values,t._values)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gc=/^__.*__$/;class mc{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return null!==this.fieldMask?new Ir(t,this.data,this.fieldMask,e,this.fieldTransforms):new Cr(t,this.data,e,this.fieldTransforms)}}class yc{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return new Ir(t,this.data,this.fieldMask,e,this.fieldTransforms)}}function vc(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw N(40011,{Ic:t})}}class wc{constructor(t,e,n,r,i,s){this.settings=t,this.databaseId=e,this.serializer=n,this.ignoreUndefinedProperties=r,void 0===i&&this.Ec(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get Ic(){return this.settings.Ic}dc(t){return new wc(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Ac(t){var e;const n=null===(e=this.path)||void 0===e?void 0:e.child(t),r=this.dc({path:n,Rc:!1});return r.Vc(t),r}mc(t){var e;const n=null===(e=this.path)||void 0===e?void 0:e.child(t),r=this.dc({path:n,Rc:!1});return r.Ec(),r}fc(t){return this.dc({path:void 0,Rc:!0})}gc(t){return Rc(t,this.settings.methodName,this.settings.yc||!1,this.path,this.settings.wc)}contains(t){return void 0!==this.fieldMask.find(e=>t.isPrefixOf(e))||void 0!==this.fieldTransforms.find(e=>t.isPrefixOf(e.field))}Ec(){if(this.path)for(let t=0;t<this.path.length;t++)this.Vc(this.path.get(t))}Vc(t){if(0===t.length)throw this.gc("Document fields must not be empty");if(vc(this.Ic)&&gc.test(t))throw this.gc('Document fields cannot begin and end with "__"')}}class bc{constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=n||Hs(t)}bc(t,e,n,r=!1){return new wc({Ic:t,methodName:e,wc:n,path:ct.emptyPath(),Rc:!1,yc:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function _c(t){const e=t._freezeSettings(),n=Hs(t._databaseId);return new bc(t._databaseId,!!e.ignoreUndefinedProperties,n)}function Ec(t,e,n,r,i,s={}){const o=t.bc(s.merge||s.mergeFields?2:0,e,n,i);Dc("Data must be an object, but it was:",o,r);const a=xc(r,o);let c,u;if(s.merge)c=new ce(o.fieldMask),u=o.fieldTransforms;else if(s.mergeFields){const t=[];for(const r of s.mergeFields){const i=kc(e,r,n);if(!o.contains(i))throw new L(P.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);Mc(t,i)||t.push(i)}c=new ce(t),u=o.fieldTransforms.filter(t=>c.covers(t.field))}else c=null,u=o.fieldTransforms;return new mc(new Ge(a),c,u)}class Tc extends fc{_toFieldTransform(t){if(2!==t.Ic)throw 1===t.Ic?t.gc(`${this._methodName}() can only appear at the top level of your update data`):t.gc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof Tc}}function Sc(t,e,n,r){const i=t.bc(1,e,n);Dc("Data must be an object, but it was:",i,r);const s=[],o=Ge.empty();ee(r,(t,r)=>{const a=Oc(e,t,n);r=(0,c.Ku)(r);const u=i.mc(a);if(r instanceof Tc)s.push(a);else{const t=Ic(r,u);null!=t&&(s.push(a),o.set(a,t))}});const a=new ce(s);return new yc(o,a,i.fieldTransforms)}function Cc(t,e,n,r,i,s){const o=t.bc(1,e,n),a=[kc(e,r,n)],u=[i];if(s.length%2!=0)throw new L(P.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let c=0;c<s.length;c+=2)a.push(kc(e,s[c])),u.push(s[c+1]);const l=[],h=Ge.empty();for(let d=a.length-1;d>=0;--d)if(!Mc(l,a[d])){const t=a[d];let e=u[d];e=(0,c.Ku)(e);const n=o.mc(t);if(e instanceof Tc)l.push(t);else{const r=Ic(e,n);null!=r&&(l.push(t),h.set(t,r))}}const f=new ce(l);return new yc(h,f,o.fieldTransforms)}function Ic(t,e){if(Ac(t=(0,c.Ku)(t)))return Dc("Unsupported field value:",e,t),xc(t,e);if(t instanceof fc)return function(t,e){if(!vc(e.Ic))throw e.gc(`${t._methodName}() can only be used with update() and set()`);if(!e.path)throw e.gc(`${t._methodName}() is not currently supported inside arrays`);const n=t._toFieldTransform(e);n&&e.fieldTransforms.push(n)}(t,e),null;if(void 0===t&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.Rc&&4!==e.Ic)throw e.gc("Nested arrays are not supported");return function(t,e){const n=[];let r=0;for(const i of t){let t=Ic(i,e.fc(r));null==t&&(t={nullValue:"NULL_VALUE"}),n.push(t),r++}return{arrayValue:{values:n}}}(t,e)}return function(t,e){if(null===(t=(0,c.Ku)(t)))return{nullValue:"NULL_VALUE"};if("number"==typeof t)return nr(e.serializer,t);if("boolean"==typeof t)return{booleanValue:t};if("string"==typeof t)return{stringValue:t};if(t instanceof Date){const n=nt.fromDate(t);return{timestampValue:oi(e.serializer,n)}}if(t instanceof nt){const n=new nt(t.seconds,1e3*Math.floor(t.nanoseconds/1e3));return{timestampValue:oi(e.serializer,n)}}if(t instanceof dc)return{geoPointValue:{latitude:t.latitude,longitude:t.longitude}};if(t instanceof lc)return{bytesValue:ai(e.serializer,t._byteString)};if(t instanceof Ja){const n=e.databaseId,r=t.firestore._databaseId;if(!r.isEqual(n))throw e.gc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:li(t.firestore._databaseId||e.databaseId,t._key.path)}}if(t instanceof pc)return function(t,e){const n={fields:{[Ce]:{stringValue:Ae},[De]:{arrayValue:{values:t.toArray().map(t=>{if("number"!=typeof t)throw e.gc("VectorValues must only contain numeric values.");return tr(e.serializer,t)})}}}};return{mapValue:n}}(t,e);throw e.gc(`Unsupported field value: ${Ka(t)}`)}(t,e)}function xc(t,e){const n={};return ne(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):ee(t,(t,r)=>{const i=Ic(r,e.Ac(t));null!=i&&(n[t]=i)}),{mapValue:{fields:n}}}function Ac(t){return!("object"!=typeof t||null===t||t instanceof Array||t instanceof Date||t instanceof nt||t instanceof dc||t instanceof lc||t instanceof Ja||t instanceof fc||t instanceof pc)}function Dc(t,e,n){if(!Ac(n)||!function(t){return"object"==typeof t&&null!==t&&(Object.getPrototypeOf(t)===Object.prototype||null===Object.getPrototypeOf(t))}(n)){const r=Ka(n);throw"an object"===r?e.gc(t+" a custom object"):e.gc(t+" "+r)}}function kc(t,e,n){if((e=(0,c.Ku)(e))instanceof hc)return e._internalPath;if("string"==typeof e)return Oc(t,e);throw Rc("Field path arguments must be of type string or ",t,!1,void 0,n)}const Nc=new RegExp("[~\\*/\\[\\]]");function Oc(t,e,n){if(e.search(Nc)>=0)throw Rc(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new hc(...e.split("."))._internalPath}catch(r){throw Rc(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function Rc(t,e,n,r,i){const s=r&&!r.isEmpty(),o=void 0!==i;let a=`Function ${e}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(s||o)&&(c+=" (found",s&&(c+=` in field ${r}`),o&&(c+=` in document ${i}`),c+=")"),new L(P.INVALID_ARGUMENT,a+t+c)}function Mc(t,e){return t.some(t=>t.isEqual(e))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fc(t){if("L"===t.limitType&&0===t.explicitOrderBy.length)throw new L(P.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Uc{convertValue(t,e="none"){switch(ke(t)){case 0:return null;case 1:return t.booleanValue;case 2:return de(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(pe(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 11:return this.convertObject(t.mapValue,e);case 10:return this.convertVectorValue(t.mapValue);default:throw N(62114,{value:t})}}convertObject(t,e){return this.convertObjectMap(t.fields,e)}convertObjectMap(t,e="none"){const n={};return ee(t,(t,r)=>{n[t]=this.convertValue(r,e)}),n}convertVectorValue(t){var e,n,r;const i=null===(r=null===(n=null===(e=t.fields)||void 0===e?void 0:e[De].arrayValue)||void 0===n?void 0:n.values)||void 0===r?void 0:r.map(t=>de(t.doubleValue));return new pc(i)}convertGeoPoint(t){return new dc(de(t.latitude),de(t.longitude))}convertArray(t,e){return(t.values||[]).map(t=>this.convertValue(t,e))}convertServerTimestamp(t,e){switch(e){case"previous":const n=be(t);return null==n?null:this.convertValue(n,e);case"estimate":return this.convertTimestamp(_e(t));default:return null}}convertTimestamp(t){const e=fe(t);return new nt(e.seconds,e.nanos)}convertDocumentKey(t,e){const n=ot.fromString(t);R(Pi(n),9688,{name:t});const r=new Se(n.get(1),n.get(3)),i=new ut(n.popFirst(5));return r.isEqual(e)||A(`Document ${i} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),i}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Bc{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class $c extends Pc{constructor(t,e,n,r,i,s){super(t,e,n,r,s),this._firestore=t,this._firestoreImpl=t,this.metadata=i}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new zc(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const n=this._document.data.field(Vc("DocumentSnapshot.get",t));if(null!==n)return this._userDataWriter.convertValue(n,e.serverTimestamps)}}}class zc extends $c{data(t={}){return super.data(t)}}class qc{constructor(t,e,n,r){this._firestore=t,this._userDataWriter=e,this._snapshot=r,this.metadata=new Bc(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(t,e){this._snapshot.docs.forEach(n=>{t.call(e,new zc(this._firestore,this._userDataWriter,n.key,n,new Bc(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new L(P.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(t,e){if(t._snapshot.oldDocs.isEmpty()){let e=0;return t._snapshot.docChanges.map(n=>{const r=new zc(t._firestore,t._userDataWriter,n.doc.key,n.doc,new Bc(t._snapshot.mutatedKeys.has(n.doc.key),t._snapshot.fromCache),t.query.converter);return n.doc,{type:"added",doc:r,oldIndex:-1,newIndex:e++}})}{let n=t._snapshot.oldDocs;return t._snapshot.docChanges.filter(t=>e||3!==t.type).map(e=>{const r=new zc(t._firestore,t._userDataWriter,e.doc.key,e.doc,new Bc(t._snapshot.mutatedKeys.has(e.doc.key),t._snapshot.fromCache),t.query.converter);let i=-1,s=-1;return 0!==e.type&&(i=n.indexOf(e.doc.key),n=n.delete(e.doc.key)),1!==e.type&&(n=n.add(e.doc),s=n.indexOf(e.doc.key)),{type:Kc(e.type),doc:r,oldIndex:i,newIndex:s}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function Kc(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return N(61501,{type:t})}}class Hc extends Uc{constructor(t){super(),this.firestore=t}convertBytes(t){return new lc(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Ja(this.firestore,null,e)}}function Gc(t){t=Ha(t,Za);const e=Ha(t.firestore,oc),n=cc(e),r=new Hc(e);return Fc(t._query),Fa(n,t._query).then(n=>new qc(e,r,t,n))}function Qc(t,e,n,...r){t=Ha(t,Ja);const i=Ha(t.firestore,oc),s=_c(i);let o;return o="string"==typeof(e=(0,c.Ku)(e))||e instanceof hc?Cc(s,"updateDoc",t._key,e,n,r):Sc(s,"updateDoc",t._key,e),Yc(i,[o.toMutation(t._key,yr.exists(!0))])}function Wc(t){return Yc(Ha(t.firestore,oc),[new kr(t._key,yr.none())])}function Xc(t,e){const n=Ha(t.firestore,oc),r=nc(t),i=jc(t.converter,e);return Yc(n,[Ec(_c(t.firestore),"addDoc",r._key,i,null!==t.converter,{}).toMutation(r._key,yr.exists(!1))]).then(()=>r)}function Yc(t,e){return function(t,e){const n=new V;return t.asyncQueue.enqueueAndForget(async()=>ca(await La(t),e,n)),n.promise}(cc(t),e)}new WeakMap;
/**
 * @license
 * Copyright 2017 Google LLC
 *
